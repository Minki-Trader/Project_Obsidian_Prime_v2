...
description: Guard Project Obsidian Prime v2 against stage-agnostic architecture drift. Use when work touches feature calculation, model training/export, pipeline materialization, artifact claims, architecture debt, stage transitions, alpha search, repo-scoped skills, agent settings, or Korean BOM/encoding-sensitive docs.
---
