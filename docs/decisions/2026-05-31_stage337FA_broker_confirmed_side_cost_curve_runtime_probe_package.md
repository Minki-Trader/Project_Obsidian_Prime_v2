# 2026-05-31 Stage337FA Decision(337FA 결정)

- run_id(실행 ID): `run337FA_materialize_broker_confirmed_side_cost_curve_runtime_probe_package_without_db_v1`
- parent_run_id(부모 실행 ID): `run337EZ_review_broker_confirmed_side_cost_curve_training_without_db_v1`
