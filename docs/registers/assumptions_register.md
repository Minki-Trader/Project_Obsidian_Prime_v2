...
| `A-002` | The provisional shared v2 working window is `2022-08-01` through `2026-04-13` inclusive until the first v2 dataset freeze is written. | New threads need one default window before the first freeze card exists. | Stage 00 records a different frozen window and fingerprint. | `open` | `2026-04-16` |
