...
|---|---|---|---|---|---|
| `A-001` | `foundation/config/top3_monthly_weights_fpmarkets_v2.csv` is still a placeholder input until real monthly weights are supplied. | Any dataset freeze or bundle built on it needs that caveat preserved. | Real monthly weights arrive or the placeholder is replaced. | `open` | `2026-04-18` |
