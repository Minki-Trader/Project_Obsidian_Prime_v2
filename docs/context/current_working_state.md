...
- current_packet(현재 작업 묶음): `stage59ao_bounded_followup_from_stage59an_v1`
- current_run(현재 실행): `run59AJ_stage59ao_bounded_followup_from_stage59an_v1`
- active_stage(활성 단계): `59AO_adapter_repair__bounded_followup_from_stage59an`
...
- adapter_under_review(검토 중 어댑터): `s59an_v46_sd2`
- status(상태): `stage59an_closed_continue_repair_in_new_bounded_stage`
...
- stage59an_decision(59AN단계 판정): `stages/59AN_adapter_repair__new_model_branch_from_stage59am/03_reviews/stage59an_decision.md`
