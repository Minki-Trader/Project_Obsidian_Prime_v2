...
- current_packet(현재 작업 묶음): `stage167_validation_pf_lift_density_preservation_v1`
- current_run(현재 실행): `run167A_stage167_validation_pf_lift_density_preservation_v1`
- active_stage(활성 단계): `167_adapter_research__validation_pf_lift_density_preservation`
- selected_research_baseline(선택 연구 기준선): `none`
- target_surface(목표 표면): `legacy_34d_kpi_lesson_only_no_legacy_inheritance`
- adapter_under_review(검토 중 어댑터): `stage167_validation_pf_lift_density_preservation_surface`
- status(상태): `stage166_open_stage167_validation_pf_lift_density_preservation_candidate_not_final`
