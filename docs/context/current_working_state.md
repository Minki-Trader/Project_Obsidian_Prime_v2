...
- active_stage(활성 단계): `116_adapter_research__v41_density_quality_balance_repair`
...
- status(상태): `stage115_closed_continue_density_quality_balance_repair_in_stage116`
