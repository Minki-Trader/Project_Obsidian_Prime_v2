...
- active_stage(활성 단계): `105_adapter_research__v41_oos_early_segment_followup_review`
...
- status(상태): `stage104_closed_continue_oos_early_segment_repair_review_in_stage105`
