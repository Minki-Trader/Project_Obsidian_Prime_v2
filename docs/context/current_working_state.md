...
- current_packet(현재 작업 묶음): `317_onnx_candidate_campaign__fresh_non_time_profit_source_rebuild_v1`
- current_run(현재 실행): `run316C_review_post_interaction_profit_scale_curve_mt5_probe_v1`
- active_stage(활성 단계): `317_onnx_candidate_campaign__fresh_non_time_profit_source_rebuild`
