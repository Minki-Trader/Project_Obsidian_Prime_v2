...
- current_packet(현재 작업 묶음): `331_overfit_guard__cross_horizon_cost_curve_parity_probe_v2`
- current_run(현재 실행): `run331B_materialize_no_retune_replay_and_resampling_controls_v1`
...
- target_surface(목표 표면): `no_retune_cross_horizon_cost_curve_parity_materialization`
...
- claim_boundary(주장 경계): `research_development_only_cross_horizon_cost_curve_parity_design_no_threshold_retuning_no_candidate_selection_no_live_readiness_no_deployment_no_operating_promotion_no_runtime_authority_no_goal_achieve`
