...
- current_packet(현재 작업 묶음): `331_overfit_guard__cross_horizon_cost_curve_parity_probe_v3`
- current_run(현재 실행): `run331C_runtime_replay_or_block_cross_horizon_probe_v1`
...
- target_surface(목표 표면): `runtime_replay_or_block_cross_horizon_probe`
- adapter_under_review(검토 중 어댑터): `none`
- status(상태): `completed_no_retune_replay_resampling_controls_no_forward_decision`
- decision(판정): `no_retune_materialization_completed_research_only_no_goal_achieve`
...
- claim_boundary(주장 경계): `research_development_only_no_retune_replay_resampling_controls_no_threshold_retuning_no_lot_optimization_no_candidate_selection_no_forward_passed_no_forward_failed_no_live_readiness_no_deployment_no_operating_promotion_no_runtime_authority_no_goal_achieve`
