...
- current_packet(현재 작업 묶음): `stage177_stage176_tp45_followup_review_v1`
- current_run(현재 실행): `run177A_stage177_stage176_tp45_followup_review_v1`
- active_stage(활성 단계): `177_adapter_research__stage176_tp45_followup_review`
- selected_research_baseline(선택 연구 기준선): `none`
- target_surface(목표 표면): `legacy_34d_kpi_lesson_only_no_legacy_inheritance`
- adapter_under_review(검토 중 어댑터): `stage176_tp45_dd_midpf_repair_surface`
- status(상태): `stage176_open_stage177_bounded_followup_due_to_tp45_dd_midpf_tradeoff_candidate_not_final`
...
- summary(요약): `stages/176_adapter_research__tp45_dd_midpf_repair/03_reviews/stage176_tp45_dd_midpf_repair_summary.csv`
