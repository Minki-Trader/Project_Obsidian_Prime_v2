...
- current_packet(현재 작업 묶음): `311_onnx_candidate_campaign__post_allocation_fresh_edge_rebuild_v1`
- current_run(현재 실행): `run310C_review_runtime_positive_fragment_allocation_mt5_probe_v1`
- active_stage(활성 단계): `311_onnx_candidate_campaign__post_allocation_fresh_edge_rebuild`
- selected_research_baseline(선택 연구 기준선): `none`
- source_stage(원천 단계): `309_onnx_candidate_campaign__split_coherent_profit_curve_source_rebuild`
