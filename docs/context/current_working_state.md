...
- current_run(현재 실행): `run230A_stage230_stage229_guard_blend_followup_review_v1`
- active_stage(활성 단계): `230_adapter_research__stage229_guard_blend_followup_review`
...
- status(상태): `stage229_open_stage230_bounded_followup_due_to_guard_blend_tradeoff_candidate_not_final`
...
- summary(요약): `stages/229_adapter_research__dual_objective_guard_blend_after_selection_tradeoff/03_reviews/stage229_guard_blend_kpi_summary.csv`
...
- pushed_commit_hash(푸시 커밋 해시): `bb0fdb1e380e09fc4b2ccc086423c230aea0905e`
