...
- active_stage: `none(stage11_closed, 활성 단계 없음)`
- active_branch: `codex/stage11-run02qrs-salvage-scout`
...
Stage 11(11단계)은 `stage11_alpha_robustness_closeout_packet_v1`로 닫혔다.
