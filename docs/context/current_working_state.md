...
- current_run(현재 실행): `run337EJ_materialize_argmax_adapter_parity_probe_contract_without_db_v1`
...
- latest_completed_run(최근 완료 실행): `run337EI_review_proxy_survivor_runtime_probe_inputs_without_db_v1`
