...
- active_stage(활성 단계): `241_adapter_research__stage240_highbonus_repair_followup_review`
...
- status(상태): `stage240_open_stage241_bounded_followup_due_to_highbonus_dd_midpf_tradeoff_candidate_not_final`
