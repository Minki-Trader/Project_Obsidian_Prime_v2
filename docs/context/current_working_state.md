...
- active_stage(활성 단계): `166_adapter_research__stage165_side_context_followup_review`
- selected_research_baseline(선택 연구 기준선): `none`
- target_surface(목표 표면): `legacy_34d_kpi_lesson_only_no_legacy_inheritance`
- adapter_under_review(검토 중 어댑터): `stage165_side_context_oos_early_repair_surface`
- status(상태): `stage165_open_stage166_side_context_repair_followup_due_to_kpi_damage_candidate_not_final`
...
- report(보고서): `stages/165_adapter_research__side_context_oos_early_repair/03_reviews/stage165_side_context_oos_early_repair_report.md`
