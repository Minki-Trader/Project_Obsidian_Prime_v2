...
- current_packet(현재 작업 묶음): `stage76_v41_dd_balance_followup_review_v1`
- current_run(현재 실행): `run76A_stage76_v41_dd_balance_followup_review_v1`
- active_stage(활성 단계): `76_adapter_research__v41_dd_balance_followup_review`
...
- status(상태): `stage75_closed_continue_v41_dd_balance_repair_in_stage76`
