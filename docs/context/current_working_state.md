...
- current_packet(현재 작업 묶음): `stage96_v41_oos_early_entry_gate_followup_review_v1`
- current_run(현재 실행): `run96A_stage96_v41_oos_early_entry_gate_followup_review_v1`
- active_stage(활성 단계): `96_adapter_research__v41_oos_early_entry_gate_followup_review`
...
- status(상태): `stage95_closed_continue_oos_early_entry_gate_followup_review_in_stage96`
