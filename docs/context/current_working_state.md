...
- adapter_under_review(검토 중 어댑터): `adjacent_period_replacement_materialization`
...
- next_run(다음 실행): `run267BD_execute_s264_aia_adjacent_period_replacement_mt5_batch_or_repair_materialization_gaps`
