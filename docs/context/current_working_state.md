...
- current_packet(현재 작업 묶음): `stage234_stage233_side_session_context_followup_review_v1`
- current_run(현재 실행): `run234A_stage234_stage233_side_session_context_followup_review_v1`
- active_stage(활성 단계): `234_adapter_research__stage233_side_session_context_followup_review`
- selected_research_baseline(선택 연구 기준선): `none`
- target_surface(목표 표면): `legacy_34d_kpi_lesson_only_v2_native_side_session_context_repair_after_lifecycle_failure`
- adapter_under_review(검토 중 어댑터): `stage233_side_session_context_repair_after_lifecycle_failure`
- status(상태): `stage233_open_stage234_bounded_followup_due_to_side_session_context_tradeoff_candidate_not_final`
