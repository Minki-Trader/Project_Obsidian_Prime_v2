...
- current_run(현재 실행): `run287C_review_density_scale_curve_pocket_mt5_probe_v1`
- active_stage(활성 단계): `288_onnx_candidate_campaign__risk_reward_exit_asymmetry_rebuild`
- selected_research_baseline(선택 연구 기준선): `none`
- source_stage(원천 단계): `287_onnx_candidate_campaign__density_scale_curve_pocket_rebuild`
...
- next_action(다음 행동): `run288A_design_risk_reward_exit_asymmetry_rebuild_packet`
