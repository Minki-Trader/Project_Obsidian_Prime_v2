...
- current_run(현재 실행): `run302C_review_payoff_convexity_profit_scale_mt5_probe_v1`
- active_stage(활성 단계): `303_onnx_candidate_campaign__regime_balanced_profit_scale_router`
- selected_research_baseline(선택 연구 기준선): `none`
- source_stage(원천 단계): `301_onnx_candidate_campaign__orthogonal_profit_source_rebuild`
