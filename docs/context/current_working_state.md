...
- current_run(현재 실행): `run333E_runtime_probe_queue_or_failure_memory_from_screen_v1`
...
- decision(판정): `cost_curve_pocket_proxy_evidence_available_runtime_probe_or_failure_memory_next`
