...
- current_packet(현재 작업 묶음): `stage59m_bounded_followup_from_stage59l_v1`
- current_run(현재 실행): `run59H_stage59m_bounded_followup_from_stage59l_v1`
- active_stage(활성 단계): `59M_adapter_repair__bounded_followup_from_stage59l`
...
- adapter_under_review(검토 중 어댑터): `s59l_v62_h4_flat_sd5`
- status(상태): `stage59l_closed_continue_repair_in_new_bounded_stage`
...
- stage59l_decision(59L단계 판정): `stages/59L_adapter_repair__bounded_followup_from_stage59k/03_reviews/stage59l_decision.md`
