...
- current_packet(현재 작업 묶음): `stage117_v41_density_quality_followup_review_v1`
- current_run(현재 실행): `run117A_stage117_v41_density_quality_followup_review_v1`
- active_stage(활성 단계): `117_adapter_research__v41_density_quality_followup_review`
...
- status(상태): `stage116_closed_continue_density_quality_followup_review_in_stage117`
...
- report(보고서): `stages/116_adapter_research__v41_density_quality_balance_repair/03_reviews/stage116_density_quality_balance_report.md`
