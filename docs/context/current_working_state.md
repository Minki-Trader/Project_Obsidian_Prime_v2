...
- current_run(현재 실행): `run288C_review_risk_reward_exit_asymmetry_mt5_probe_v1`
- active_stage(활성 단계): `289_onnx_candidate_campaign__regime_conditioned_edge_surface_rebuild`
- selected_research_baseline(선택 연구 기준선): `none`
- source_stage(원천 단계): `288_onnx_candidate_campaign__risk_reward_exit_asymmetry_rebuild`
