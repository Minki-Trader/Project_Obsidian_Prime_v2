...
- current_packet(현재 작업 묶음): `stage90_v41_drawdown_oos_early_followup_review_v1`
- current_run(현재 실행): `run90A_stage90_v41_drawdown_oos_early_followup_review_v1`
- active_stage(활성 단계): `90_adapter_research__v41_drawdown_oos_early_followup_review`
...
- status(상태): `stage89_closed_continue_drawdown_oos_early_followup_review_in_stage90`
