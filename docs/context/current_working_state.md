...
- current_packet(현재 작업 묶음): `296_onnx_candidate_campaign__density_floor_profit_expansion_rebuild_v1`
- current_run(현재 실행): `run295C_review_split_consistent_outcome_distillation_mt5_probe_v1`
- active_stage(활성 단계): `296_onnx_candidate_campaign__density_floor_profit_expansion_rebuild`
- selected_research_baseline(선택 연구 기준선): `none`
- source_stage(원천 단계): `295_onnx_candidate_campaign__split_consistent_outcome_distillation_rebuild`
- target_surface(목표 표면): `none`
- adapter_under_review(검토 중 어댑터): `none`
- status(상태): `opened_density_floor_profit_expansion_rebuild`
