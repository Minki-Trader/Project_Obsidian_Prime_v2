...
- adapter_under_review(검토 중 어댑터): `aggressive_candidate_pressure_queue`
...
- next_run(다음 실행): `run267BI_repair_tester_handoff_and_execute_aggressive_pressure_queue_tranche`
