...
- current_packet(현재 작업 묶음): `stage159_stage158_validation_pf_followup_review_v1`
- current_run(현재 실행): `run159A_stage159_stage158_validation_pf_followup_review_v1`
- active_stage(활성 단계): `159_adapter_research__stage158_validation_pf_followup_review`
- selected_research_baseline(선택 연구 기준선): `none`
- target_surface(목표 표면): `legacy_34d_kpi_lesson_only_no_legacy_inheritance`
- adapter_under_review(검토 중 어댑터): `stage159_stage158_validation_pf_followup_surface`
- status(상태): `stage158_closed_continue_stage159_stage158_followup_review_due_to_validation_pf_or_oos_damage_candidate_not_final_stage159_open_planned`
...
- report(보고서): `stages/158_adapter_research__stage156_validation_pf_margin_repair/03_reviews/stage158_validation_pf_margin_report.md`
