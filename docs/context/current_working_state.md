...
- current_run(현재 실행): `run337DU_materialize_broad_validation_failure_control_residual_repair_inputs_without_db_v1`
...
- latest_completed_run(최근 완료 실행): `run337DT_design_broad_validation_failure_control_residual_repair_without_db_v1`
