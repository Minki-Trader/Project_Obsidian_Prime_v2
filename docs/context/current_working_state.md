...
- current_run(현재 실행): `run301C_review_orthogonal_profit_source_mt5_probe_v1`
- active_stage(활성 단계): `302_onnx_candidate_campaign__payoff_convexity_profit_scale_rebuild`
- selected_research_baseline(선택 연구 기준선): `none`
- source_stage(원천 단계): `300_onnx_candidate_campaign__split_forward_trade_shape_generalization_rebuild`
