...
- current_packet(현재 작업 묶음): `stage59aa_bounded_followup_from_stage59z_v1`
- current_run(현재 실행): `run59V_stage59aa_bounded_followup_from_stage59z_v1`
- active_stage(활성 단계): `59AA_adapter_repair__bounded_followup_from_stage59z`
...
- adapter_under_review(검토 중 어댑터): `s59z_v64_gap14_t59_h2_sd5`
- status(상태): `stage59z_closed_continue_repair_in_new_bounded_stage`
