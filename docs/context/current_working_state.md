...
- current_run(현재 실행): `run303C_review_regime_balanced_profit_scale_router_mt5_probe_v1`
- active_stage(활성 단계): `304_onnx_candidate_campaign__curve_pocket_aware_profit_source_rebuild`
