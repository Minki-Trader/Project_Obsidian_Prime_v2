...
- current_packet(현재 작업 묶음): `stage68_dd_net_balance_repair_v1`
- current_run(현재 실행): `run68A_stage68_dd_net_balance_repair_v1`
- active_stage(활성 단계): `68_adapter_research__dd_net_balance_repair`
...
- status(상태): `stage67_closed_continue_dd_net_balance_repair_in_stage68`
