...
- current_packet(현재 작업 묶음): `stage185_stage184_midsegment_quality_followup_review_v1`
- current_run(현재 실행): `run185A_stage185_stage184_midsegment_quality_followup_review_v1`
- active_stage(활성 단계): `185_adapter_research__stage184_midsegment_quality_followup_review`
- selected_research_baseline(선택 연구 기준선): `none`
- target_surface(목표 표면): `legacy_34d_kpi_lesson_only_no_legacy_inheritance`
- adapter_under_review(검토 중 어댑터): `stage184_tp45_midwide_midsegment_quality_surface`
- status(상태): `stage184_open_stage185_bounded_followup_due_to_midsegment_quality_tradeoff_candidate_not_final`
...
- pushed_commit_hash(푸시 커밋 해시): `4d7febab4cc8f55b23a65f6f33f2615bf973301d`
