...
- adapter_under_review(검토 중 어댑터): `runtime_gap_aware_sixth_followup_or_prune_balance_timeslice_trade_quality_review`
...
- latest_materialization(최신 물질화): run267DY(267DY 실행) variants(변형) `9`, attempts(시도) `9`, held_rows(보류 행) `1`, report(보고서) `stages/267_adapter_research__baseline_candidate_racing_protocol/03_reviews/stage267_run267DY_runtime_gap_aware_sixth_followup_or_prune_materialization.md`.
