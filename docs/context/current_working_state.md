...
- current_run(현재 실행): `run256A_stage256_source_feature_branch_after_binding_lifecycle_no_gain_v1`
- active_stage(활성 단계): `256_adapter_research__source_feature_branch_after_binding_lifecycle_no_gain`
- selected_research_baseline(선택 연구 기준선): `none`
- target_surface(목표 표면): `legacy_34d_kpi_lesson_only_v2_native_source_feature_branch_after_binding_lifecycle_no_gain`
...
- report(보고서): `stages/255_adapter_research__stage254_nonbinding_source_followup_review/03_reviews/stage255_stage254_nonbinding_source_followup_review.md`
