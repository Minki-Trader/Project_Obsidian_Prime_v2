...
- current_packet(현재 작업 묶음): `stage206_stage204_long_session_dd_micro_repair_v1`
- current_run(현재 실행): `run206A_stage206_stage204_long_session_dd_micro_repair_v1`
- active_stage(활성 단계): `206_adapter_research__stage204_long_session_dd_micro_repair`
...
- status(상태): `stage205_open_stage206_long_session_dd_micro_repair_candidate_not_final`
...
- run(실행): `run205A_stage205_stage204_selective_probability_margin_followup_review_v1`
...
- report(보고서): `stages/205_adapter_research__stage204_selective_probability_margin_followup_review/03_reviews/stage205_followup_review.md`
