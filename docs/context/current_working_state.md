...
- current_packet(현재 작업 묶음): `295_onnx_candidate_campaign__split_consistent_outcome_distillation_rebuild_v1`
- current_run(현재 실행): `run294C_review_mt5_outcome_relabel_directional_flip_mt5_probe_v1`
- active_stage(활성 단계): `295_onnx_candidate_campaign__split_consistent_outcome_distillation_rebuild`
