...
- adapter_under_review(검토 중 어댑터): `pool_wide_state_feature_engineering_second_followup_mt5_execution`
...
- next_run(다음 실행): `run267AY_review_pool_wide_state_feature_engineering_second_followup_mt5_results`
