...
- current_packet(현재 작업 묶음): `308_onnx_candidate_campaign__non_return_rank_profit_source_rebuild_v1`
- current_run(현재 실행): `run307C_review_post_trade_shape_scale_mt5_probe_v1`
- active_stage(활성 단계): `308_onnx_candidate_campaign__non_return_rank_profit_source_rebuild`
- selected_research_baseline(선택 연구 기준선): `none`
- source_stage(원천 단계): `306_onnx_candidate_campaign__anti_surface_trade_shape_rebuild`
