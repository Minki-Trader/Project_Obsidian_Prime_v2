...
- current_packet(현재 작업 묶음): `stage189_stage188_context_feature_followup_review_v1`
- current_run(현재 실행): `run189A_stage189_stage188_context_feature_followup_review_v1`
- active_stage(활성 단계): `189_adapter_research__stage188_context_feature_followup_review`
- selected_research_baseline(선택 연구 기준선): `none`
- target_surface(목표 표면): `legacy_34d_kpi_lesson_only_v2_native_context_feature_branch`
- adapter_under_review(검토 중 어댑터): `stage188_v2_native_context_feature_branch`
- status(상태): `stage188_open_stage189_bounded_followup_due_to_context_feature_tradeoff_candidate_not_final`
