...
- current_run(현재 실행): `run298C_review_profit_scale_edge_amplification_mt5_probe_v1`
- active_stage(활성 단계): `299_onnx_candidate_campaign__runtime_realized_trade_shape_rebuild`
- selected_research_baseline(선택 연구 기준선): `none`
- source_stage(원천 단계): `297_onnx_candidate_campaign__bilevel_curve_monotonic_profit_rebuild`
