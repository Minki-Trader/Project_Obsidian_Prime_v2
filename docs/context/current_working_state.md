...
- current_run(현재 실행): `run337CR_materialize_weak_density_control_alignment_repair_inputs_without_db_v1`
...
- latest_completed_run(최근 완료 실행): `run337CQ_design_weak_density_and_control_alignment_repair_without_db_v1`
