...
- current_run(현재 실행): `run330C_forward_mt5_or_score_curve_review_v1`
...
- status(상태): `stage330_run330B_materialization_completed_curve_review_next`
- decision(판정): `stage330B_control_surfaces_materialized_curve_and_runtime_review_next`
