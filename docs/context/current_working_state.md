...
- current_packet(현재 작업 묶음): `stage145_stage144_shortgate_quality_followup_review_v1`
- current_run(현재 실행): `run145A_stage145_stage144_shortgate_quality_followup_review_v1`
- active_stage(활성 단계): `145_adapter_research__stage144_shortgate_quality_followup_review`
- selected_research_baseline(선택 연구 기준): `none`
- target_surface(목표 표면): `legacy_34d_kpi_lesson_only_no_legacy_inheritance`
- adapter_under_review(검토 중 어댑터): `stage145_shortgate_quality_followup_review_surface`
- status(상태): `stage144_closed_continue_stage145_shortgate_quality_followup_review_due_to_damage_or_no_repair_candidate_not_final_stage145_open_planned`
