...
- current_run(현재 실행): `run337BW_review_model_scout_runtime_probe_without_db_v1`
...
- latest_completed_run(최근 완료 실행): `run337BV_execute_model_scout_mt5_runtime_probe_without_db_v1`
