...
- active_stage(활성 단계): `224_adapter_research__stage223_oos_recovery_followup_review`
...
- status(상태): `stage223_open_stage224_bounded_followup_due_to_oos_recovery_tradeoff_candidate_not_final`
...
- pushed_commit_hash(푸시 커밋 해시): `ef25cfecc56dde0bf1ba6f60e9568f4d0f9002e1`
