...
- adapter_under_review(검토 중 어댑터): `adjacent_period_replacement_mt5_execution`
...
- next_run(다음 실행): `run267BD_repair_s264_aia_adjacent_period_replacement_mt5_execution_blocker`
