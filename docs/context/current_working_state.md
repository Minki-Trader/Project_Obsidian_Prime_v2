...
- current_packet(현재 작업 묶음): `stage92_v41_sl205_net_recovery_followup_review_v1`
- current_run(현재 실행): `run92A_stage92_v41_sl205_net_recovery_followup_review_v1`
- active_stage(활성 단계): `92_adapter_research__v41_sl205_net_recovery_followup_review`
- selected_research_baseline(선택 연구 기준): `research_package_only_reference_surface`
- target_surface(목표 표면): `legacy_34d_kpi_lesson_only_no_legacy_inheritance`
- adapter_under_review(검토 중 어댑터): `s89_v41_h3_risk475_gate08_sl205_tp38_cd10`
- status(상태): `stage91_closed_continue_sl205_net_recovery_followup_review_in_stage92`
