...
- current_packet(현재 작업 묶음): `stage82_v41_early_oos_followup_review_v1`
- current_run(현재 실행): `run82A_stage82_v41_early_oos_followup_review_v1`
- active_stage(활성 단계): `82_adapter_research__v41_early_oos_followup_review`
...
- status(상태): `stage81_closed_continue_early_oos_segment_review_in_stage82`
...
- report(보고서): `stages/81_adapter_research__v41_early_oos_segment_repair/03_reviews/stage81_v41_early_oos_segment_report.md`
