...
- current_run(현재 실행): `run297C_review_bilevel_curve_monotonic_profit_mt5_probe_v1`
- active_stage(활성 단계): `298_onnx_candidate_campaign__profit_scale_edge_amplification_rebuild`
