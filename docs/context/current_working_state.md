...
- current_packet(현재 작업 묶음): `stage232_stage231_lifecycle_followup_review_v1`
- current_run(현재 실행): `run232A_stage232_stage231_lifecycle_followup_review_v1`
- active_stage(활성 단계): `232_adapter_research__stage231_lifecycle_followup_review`
- selected_research_baseline(선택 연구 기준선): `none`
- target_surface(목표 표면): `legacy_34d_kpi_lesson_only_v2_native_lifecycle_repair_after_guard_blend_failure`
- adapter_under_review(검토 중 어댑터): `stage231_lifecycle_repair_after_guard_blend_failure`
- status(상태): `stage231_open_stage232_bounded_followup_due_to_lifecycle_repair_tradeoff_candidate_not_final`
...
- summary(요약): `stages/231_adapter_research__midpf_oos_repair_after_guard_blend_failure/03_reviews/stage231_lifecycle_repair_kpi_summary.csv`
