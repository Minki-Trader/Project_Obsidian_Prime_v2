...
- current_packet(현재 작업 묶음): `313_onnx_candidate_campaign__runtime_outcome_source_pivot_rebuild_v1`
- current_run(현재 실행): `run312C_review_fresh_model_asymmetry_mt5_probe_v1`
- active_stage(활성 단계): `313_onnx_candidate_campaign__runtime_outcome_source_pivot_rebuild`
