...
- current_packet(현재 작업 묶음): `stage248_entry_source_quality_repair_after_stage246_soft_guard_tradeoff_v1`
- current_run(현재 실행): `run248A_stage248_entry_source_quality_repair_after_stage246_soft_guard_tradeoff_v1`
- active_stage(활성 단계): `248_adapter_research__entry_source_quality_repair_after_stage246_soft_guard_tradeoff`
...
- report(보고서): `stages/247_adapter_research__stage246_soft_guard_followup_review/03_reviews/stage247_stage246_soft_guard_followup_review.md`
- tradeoff_matrix(상충 행렬): `stages/247_adapter_research__stage246_soft_guard_followup_review/03_reviews/stage247_tradeoff_review_matrix.csv`
