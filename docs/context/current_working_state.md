...
- current_packet(현재 작업 묶음): `stage98_v41_oos_early_lifecycle_followup_review_v1`
- current_run(현재 실행): `run98A_stage98_v41_oos_early_lifecycle_followup_review_v1`
- active_stage(활성 단계): `98_adapter_research__v41_oos_early_lifecycle_followup_review`
...
- status(상태): `stage97_closed_continue_oos_early_lifecycle_followup_review_in_stage98`
