...
- current_packet(현재 작업 묶음): `stage59ad_bounded_followup_from_stage59ac_v1`
- current_run(현재 실행): `run59Y_stage59ad_bounded_followup_from_stage59ac_v1`
- active_stage(활성 단계): `59AD_adapter_repair__bounded_followup_from_stage59ac`
...
- adapter_under_review(검토 중 어댑터): `s59ac_v64_gap14_t59_h4_entrytrans_sd5`
- status(상태): `stage59ac_closed_continue_repair_in_new_bounded_stage`
...
- stage59ac_decision(59AC단계 판정): `stages/59AC_adapter_repair__bounded_followup_from_stage59ab/03_reviews/stage59ac_decision.md`
