...
- current_run(현재 실행): `run337BZ_runtime_kpi_attribution_and_no_overfit_research_matrix_without_db_v1`
...
- latest_completed_run(최근 완료 실행): `run337BY_completed_day_lock_or_tester_visibility_repair_without_db_v1`
- next_action(다음 행동): `run337BZ_runtime_kpi_attribution_and_no_overfit_research_matrix_without_db_v1`
- claim_boundary(주장 경계): `research_development_only_stage337BY_completed_day_lock_without_db_no_model_training_no_threshold_tuning_no_lot_optimization_no_candidate_selection_no_forward_passed_no_forward_failed_no_live_readiness_no_deployment_no_operating_promotion_no_runtime_authority_no_goal_achieve`
