...
- current_packet(현재 작업 묶음): `stage84_v41_hybrid_sl_cooldown_followup_review_v1`
- current_run(현재 실행): `run84A_stage84_v41_hybrid_sl_cooldown_followup_review_v1`
- active_stage(활성 단계): `84_adapter_research__v41_hybrid_sl_cooldown_followup_review`
...
- status(상태): `stage83_closed_continue_hybrid_sl_cooldown_review_in_stage84`
