...
- active_stage(활성 단계): `94_adapter_research__v41_sl210_oos_early_followup_review`
...
- status(상태): `stage93_closed_continue_sl210_oos_early_followup_review_in_stage94`
