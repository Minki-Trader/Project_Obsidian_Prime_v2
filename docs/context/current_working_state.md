...
- current_packet(현재 작업 묶음): `331_overfit_guard__cross_horizon_cost_curve_parity_probe_v1`
- current_run(현재 실행): `run331A_design_cross_horizon_cost_curve_parity_probe_packet_v1`
...
- target_surface(목표 표면): `cross_horizon_cost_curve_parity_probe`
- adapter_under_review(검토 중 어댑터): `none`
- status(상태): `open_planned`
- decision(판정): `stage330_closed_no_selection_forward_safe_rebuild_clues_preserved_stage331_open`
...
- next_action(다음 행동): `run331A_design_cross_horizon_cost_curve_parity_probe_packet_v1`
- claim_boundary(주장 경계): `research_development_only_cross_horizon_cost_curve_parity_probe_no_threshold_retuning_no_candidate_selection_no_live_readiness_no_deployment_no_operating_promotion_no_runtime_authority_no_goal_achieve`
