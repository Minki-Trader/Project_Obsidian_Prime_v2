...
- current_packet(현재 작업 묶음): `stage204_selective_probability_margin_recovery_repair_v1`
- current_run(현재 실행): `run204A_stage204_selective_probability_margin_recovery_repair_v1`
- active_stage(활성 단계): `204_adapter_research__selective_probability_margin_recovery_repair`
...
- status(상태): `stage203_open_stage204_selective_probability_margin_recovery_repair_candidate_not_final`
...
- run(실행): `run203A_stage203_stage202_probability_binding_followup_review_v1`
...
- report(보고서): `stages/203_adapter_research__stage202_probability_binding_followup_review/03_reviews/stage203_followup_review.md`
