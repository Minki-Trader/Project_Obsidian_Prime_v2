...
- current_packet(현재 작업 묶음): `stage191_stage190_net_preserving_dd_followup_review_v1`
- current_run(현재 실행): `run191A_stage191_stage190_net_preserving_dd_followup_review_v1`
- active_stage(활성 단계): `191_adapter_research__stage190_net_preserving_dd_followup_review`
- selected_research_baseline(선택 연구 기준선): `none`
- target_surface(목표 표면): `legacy_34d_kpi_lesson_only_v2_native_net_preserving_dd_repair`
- adapter_under_review(검토 중 어댑터): `stage190_net_preserving_dd_repair`
- status(상태): `stage190_open_stage191_bounded_followup_due_to_net_preserving_dd_tradeoff_candidate_not_final`
...
- summary(요약): `stages/190_adapter_research__net_preserving_dd_repair_from_long_strict_clue/03_reviews/stage190_net_preserving_dd_summary.csv`
