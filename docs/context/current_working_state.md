...
- current_packet(현재 작업 묶음): `stage129_v41_quality_density_followup_review_v1`
- current_run(현재 실행): `run129A_stage129_v41_quality_density_followup_review_v1`
- active_stage(활성 단계): `129_adapter_research__v41_quality_density_followup_review`
...
- status(상태): `stage128_closed_continue_quality_density_followup_review_in_stage129_due_to_damage_or_no_repair`
