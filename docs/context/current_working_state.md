...
- adapter_under_review(검토 중 어댑터): `pool_wide_balance_timeslice_trade_quality_review`
...
- next_run(다음 실행): `run267P_pool_wide_internal_feature_order_confirmation_and_adapter_design`
