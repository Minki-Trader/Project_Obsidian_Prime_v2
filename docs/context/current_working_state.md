...
- current_packet(현재 작업 묶음): `stage155_stage154_oos_mid_validation_followup_review_v1`
- current_run(현재 실행): `run155A_stage155_stage154_oos_mid_validation_followup_review_v1`
- active_stage(활성 단계): `155_adapter_research__stage154_oos_mid_validation_followup_review`
- selected_research_baseline(선택 연구 기준선): `none`
- target_surface(목표 표면): `legacy_34d_kpi_lesson_only_no_legacy_inheritance`
- adapter_under_review(검토 중 어댑터): `stage155_stage154_oos_mid_validation_followup_review_surface`
- status(상태): `stage154_closed_continue_stage155_stage154_followup_review_due_to_damage_or_no_gain_candidate_not_final_stage155_open_planned`
...
- report(보고서): `stages/154_adapter_research__oos_mid_edge_restore_validation_repair/03_reviews/stage154_oos_mid_validation_repair_report.md`
