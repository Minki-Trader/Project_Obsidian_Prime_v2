...
- current_run(현재 실행): `run323A_build_adapter_package_for_cp322a_selected_curve_v1`
- active_stage(활성 단계): `324_onnx_candidate_campaign__onnx_go_pressure_for_cp322a_adapter`
- selected_research_baseline(선택 연구 기준선): `none`
- source_stage(원천 단계): `323_onnx_candidate_campaign__selected_curve_adapter_package`
- target_surface(목표 표면): `cp322A_adapter_onnx_go_pressure`
- adapter_under_review(검토 중 어댑터): `stage323_cp322a_selected_curve_adapter_package_v1`
- status(상태): `opened_onnx_go_pressure_after_stage323_adapter_package`
...
- next_action(다음 행동): `run324A_execute_onnx_go_pressure_for_cp322a_adapter_package`
- claim_boundary(주장 경계): `research_development_only_no_live_readiness_no_runtime_authority_no_operating_promotion_no_operating_reference_no_production_baseline_no_deployment_no_onnx_until_onnx_go_pressure_gate`
