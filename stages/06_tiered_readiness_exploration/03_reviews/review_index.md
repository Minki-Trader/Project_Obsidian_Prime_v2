...
13. `../03_reviews/note_fpmarkets_v2_tier_b_reduced_context_model_anchor_0001.md`
14. `../../../docs/decisions/2026-04-21_stage06_first_tier_b_charter_adopted.md`
15. `../../../docs/adr/0003_tier_b_reduced_risk_experiment_charter.md`
16. `../../../docs/decisions/2026-04-21_stage06_first_scorecard_materialized.md`
17. `../../../docs/decisions/2026-04-20_stage06_first_readiness_boundary.md`
18. `../../../docs/decisions/2026-04-20_stage05_close_and_stage06_open.md`
19. `../../../docs/policies/tiered_readiness_exploration.md`
20. `../03_reviews/report_fpmarkets_v2_tiered_readiness_0001.md`
21. `../../../docs/decisions/2026-04-18_tiered_readiness_exploration_boundary.md`
22. `../../05_exploration_kernel_freeze/04_selected/selection_status.md`
23. `../../05_exploration_kernel_freeze/03_reviews/report_fpmarkets_v2_runtime_broader_parity_0002.md`
24. `../../05_exploration_kernel_freeze/03_reviews/report_fpmarkets_v2_runtime_helper_parity_0001.md`
25. `../../05_exploration_kernel_freeze/03_reviews/report_fpmarkets_v2_runtime_broader_parity_0003.md`
26. `../04_selected/selection_status.md`
...
- draft anchor read: `a draft-only Stage 06 anchor note now records the current preference for one shared Tier B reduced-context model plus subtype tags, without opening Stage 07 or changing any official state document`
...
- should a later stage materialize one shared `Tier B reduced-context model` with `b_eq_dark / b_macro_late / b_residual_sparse` tags before considering any two-way or three-way Tier B model split?
