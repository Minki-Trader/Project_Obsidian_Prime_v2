...
- latest_forward_review(최신 전진 검토): `run330F_raw_forward_mt5_kpi_regime_cost_curve_review_v1`
- latest_failure_memory(최신 실패 기억): `run330G_raw_forward_failure_fragility_memory_and_overfit_followup_v1`
