...
- stage_status(단계 상태): `open_score_curve_pressure_completed`
...
- latest_completed_run(최신 완료 실행): `run330C_forward_mt5_or_score_curve_review_v1`
...
- effect(효과): run330C(330C 실행)는 점수 곡선/비용/로트/세션 MT5 참고를 만들었지만, raw-forward MT5가 없어 선택 후보와 Forward Passed(전진 통과)는 없다.
