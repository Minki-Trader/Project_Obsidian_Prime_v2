# frontier39B_regime_conditioned_score_paired_ablation_proxy_v1 Gate Audit(frontier39B_regime_conditioned_score_paired_ablation_proxy_v1 게이트 감사)
...
- result_judgment(결과 판정): `ablation_guardrail_failed_despite_scout_surface`
- runtime_probe(런타임 탐침): `runtime_probe_out_of_scope_by_claim_proxy_no_seed_or_runtime_candidate`
