...
- latest_run(최신 실행): `run337EB_design_validation_density_trade_count_repair_without_db_v1`
- latest_decision(최신 결정): `stage337EB_open_run337EC_materialize_validation_density_trade_count_repair_inputs`
...
- rebuild_status(재구축 상태): `completed_stage337EB_validation_density_trade_count_repair_design_no_training_no_selection`
