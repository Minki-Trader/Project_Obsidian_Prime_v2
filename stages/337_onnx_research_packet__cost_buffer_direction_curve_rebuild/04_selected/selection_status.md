...
- latest_run(최신 실행): `run337DA_train_objective_feature_contract_pivot_candidates_without_db_v1`
- latest_decision(최신 결정): `stage337DA_open_run337DB_review_objective_feature_contract_pivot_training`
...
- rebuild_status(재구축 상태): `completed_stage337DA_objective_feature_contract_pivot_candidates_trained_review_required_no_selection_no_mt5`
