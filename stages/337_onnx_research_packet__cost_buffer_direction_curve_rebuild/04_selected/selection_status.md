...
- latest_run(최신 실행): `run337CS_train_weak_density_control_repaired_candidates_without_db_v1`
- latest_decision(최신 결정): `stage337CS_open_run337CT_review_weak_density_control_repaired_candidates`
...
- rebuild_status(재구축 상태): `completed_stage337CS_weak_density_control_repaired_training_review_required_no_selection_no_mt5`
