...
- latest_run(최신 실행): `run337CE_execute_lifecycle_aware_mt5_runtime_probe_without_db_v1`
- latest_decision(최신 결정): `stage337CE_open_run337CF_runtime_probe_gap_and_failure_attribution_review`
...
- rebuild_status(재구축 상태): `completed_stage337CE_lifecycle_aware_mt5_runtime_probe_overlap_parity_tester_gap_remains_no_forward_decision`
