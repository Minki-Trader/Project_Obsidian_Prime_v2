...
- latest_run(최신 실행): `run337DB_review_objective_feature_contract_pivot_training_without_db_v1`
- latest_decision(최신 결정): `stage337DB_open_run337DC_design_cost_shape_two_stage_handoff_repair`
- current_run(현재 실행): `run337DC_design_cost_shape_two_stage_handoff_repair_without_db_v1`
- frozen_subject(고정 대상): `cp322A_cp321b_exact_replay_control_surface`
- exact_cp322a_forward_handoff(정확 cp322A 전진 인계): `not_feasible_under_frozen_rules`
- preserved_status(보존 상태): `research_artifact_only`
- rebuild_status(재구축 상태): `completed_stage337DB_objective_feature_training_review_cost_shape_blocks_no_selection_no_mt5`
