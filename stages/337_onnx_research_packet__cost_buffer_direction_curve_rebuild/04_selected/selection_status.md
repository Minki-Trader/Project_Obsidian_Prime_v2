...
- latest_run(최신 실행): `run337ED_review_validation_density_trade_count_repair_inputs_without_db_v1`
- latest_decision(최신 결정): `stage337ED_open_run337EE_train_validation_density_trade_count_repair_candidates`
...
- rebuild_status(재구축 상태): `completed_stage337ED_repair_inputs_review_guarded_training_eligible_no_selection_no_mt5`
