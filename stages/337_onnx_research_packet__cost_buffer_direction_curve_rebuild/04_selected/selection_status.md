...
- latest_run(최신 실행): `run337CT_review_weak_density_control_repaired_candidates_without_db_v1`
- latest_decision(최신 결정): `stage337CT_open_run337CU_feature_label_separability_control_repair_design`
...
- rebuild_status(재구축 상태): `completed_stage337CT_release_lock_review_no_mt5_no_selection`
