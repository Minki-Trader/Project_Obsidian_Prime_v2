...
- latest_run(최신 실행): `run337CB_lifecycle_aware_no_overfit_design_without_db_v1`
- latest_decision(최신 결정): `stage337CB_open_run337CC_materialize_lifecycle_aware_no_overfit_inputs`
...
- rebuild_status(재구축 상태): `completed_stage337CB_lifecycle_aware_no_overfit_design_materialized_no_training_no_selection`
