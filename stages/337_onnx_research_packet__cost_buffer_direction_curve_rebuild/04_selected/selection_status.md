...
- latest_run(최신 실행): `run337CR_materialize_weak_density_control_alignment_repair_inputs_without_db_v1`
- latest_decision(최신 결정): `stage337CR_open_run337CS_train_weak_density_control_repaired_candidates`
...
- rebuild_status(재구축 상태): `completed_stage337CR_weak_density_control_alignment_repair_inputs_materialized_no_training_no_selection`
