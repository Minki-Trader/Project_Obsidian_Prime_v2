...
- latest_run(최신 실행): `run337CG_design_directional_label_action_policy_repair_without_db_v1`
- latest_decision(최신 결정): `stage337CG_open_run337CH_materialize_directional_label_action_policy_repair_inputs`
...
- rebuild_status(재구축 상태): `completed_stage337CG_directional_label_action_policy_repair_design_no_training_no_selection`
