...
- latest_run(최신 실행): `run337BO_materialize_forward_safe_route_signal_rebuild_inputs_without_db_v1`
- latest_decision(최신 결정): `stage337BO_open_run337BP_live_computable_feature_frame_preflight`
