...
- latest_run(최신 실행): `run337DZ_train_guarded_transfer_density_control_repair_candidates_without_db_v1`
- latest_decision(최신 결정): `stage337DZ_open_run337EA_review_guarded_transfer_density_control_training`
...
- rebuild_status(재구축 상태): `completed_stage337DZ_guarded_transfer_density_control_repair_candidates_trained_onnx_materialized_review_required_no_selection_no_mt5`
