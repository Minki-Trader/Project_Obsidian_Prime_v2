...
- latest_run(최신 실행): `run337DG_design_validation_pocket_cost_shape_repair_without_db_v1`
- latest_decision(최신 결정): `stage337DG_open_run337DH_materialize_validation_pocket_cost_shape_repair_inputs`
...
- rebuild_status(재구축 상태): `completed_stage337DG_validation_pocket_cost_shape_repair_design_no_training_no_selection`
