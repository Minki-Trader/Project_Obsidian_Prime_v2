...
- latest_run(최신 실행): `run337EA_review_guarded_transfer_density_control_training_without_db_v1`
- latest_decision(최신 결정): `stage337EA_open_run337EB_design_validation_density_trade_count_repair`
...
- rebuild_status(재구축 상태): `completed_stage337EA_guarded_transfer_density_control_training_review_validation_floor_density_blocks_release_no_selection_no_mt5`
