...
- latest_run(최신 실행): `run337CJ_materialize_directional_label_action_candidate_training_inputs_without_db_v1`
- latest_decision(최신 결정): `stage337CJ_open_run337CK_guarded_directional_label_action_candidate_training`
...
- rebuild_status(재구축 상태): `completed_stage337CJ_directional_label_action_candidate_training_inputs_materialized_no_training_no_selection`
