...
- latest_run(최신 실행): `run337EF_review_validation_density_trade_count_repair_training_without_db_v1`
- latest_decision(최신 결정): `stage337EF_open_run337EG_review_proxy_survivor_attribution_package_precheck`
...
- rebuild_status(재구축 상태): `completed_stage337EF_training_review_proxy_survivors_found_no_selection_no_mt5`
