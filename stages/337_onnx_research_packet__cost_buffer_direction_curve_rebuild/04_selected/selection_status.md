...
- latest_run(최신 실행): `run337EC_materialize_validation_density_trade_count_repair_inputs_without_db_v1`
- latest_decision(최신 결정): `stage337EC_open_run337ED_review_validation_density_trade_count_repair_inputs`
...
- rebuild_status(재구축 상태): `completed_stage337EC_validation_density_trade_count_repair_inputs_materialized_no_training_no_selection`
