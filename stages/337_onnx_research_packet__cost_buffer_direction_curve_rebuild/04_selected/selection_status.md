...
- latest_decision(최신 결정): `stage337AZ_open_run337BA_materialize_no_overfit_repair_inputs_without_db_no_selection`
...
- no_overfit_repair_design_rows(무과적합 수리 설계 행): `5`
- falsification_gate_rows(반증 게이트 행): `6`
- materialization_queue_rows(물질화 대기열 행): `2`
