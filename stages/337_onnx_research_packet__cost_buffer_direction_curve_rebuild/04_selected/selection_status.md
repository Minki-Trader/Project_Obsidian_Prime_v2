...
- latest_run(최신 실행): `run337DH_materialize_validation_pocket_cost_shape_repair_inputs_without_db_v1`
- latest_decision(최신 결정): `stage337DH_open_run337DI_review_validation_pocket_cost_shape_repair_inputs`
...
- rebuild_status(재구축 상태): `completed_stage337DH_validation_pocket_cost_shape_repair_inputs_materialized_no_training_no_selection`
