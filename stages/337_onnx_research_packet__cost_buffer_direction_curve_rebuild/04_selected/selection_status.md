...
- latest_decision(최신 결정): `stage337G_blueprints_reviewed_open_run337H_packages_no_training_no_mt5_no_selection`
...
- next_action(다음 행동): `run337H_materialize_reviewed_execution_packages_v1`
