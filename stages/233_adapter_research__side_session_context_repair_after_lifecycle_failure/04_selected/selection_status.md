# Stage233 Selection Status(233단계 선택 상태)
...
- source_decision(원천 판정): `open_stage233_bounded_side_session_context_repair_after_lifecycle_failure_candidate_not_final`
- next_action(다음 행동): `run233A_stage233_side_session_context_repair_after_lifecycle_failure_v1`
