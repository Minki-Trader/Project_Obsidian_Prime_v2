...
- source_stage231_evidence_commit(원천 231단계 근거 커밋): `adc7978cadb5d930ae557c058a64968fda528f91`
- source_stage231_hash_record_commit(원천 231단계 해시 기록 커밋): `87115447243528f615541241cfffc31f4e202740`
- external_verification_status(외부 검증 상태): `review_only_source_stage231_mt5_reports_completed`
- report(보고서): `stages/232_adapter_research__stage231_lifecycle_followup_review/03_reviews/stage232_lifecycle_followup_review.md`
...
- route_matrix(경로 행렬): `stages/232_adapter_research__stage231_lifecycle_followup_review/03_reviews/stage232_route_matrix.csv`
