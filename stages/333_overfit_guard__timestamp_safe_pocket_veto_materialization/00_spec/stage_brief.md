...
- stage_id(단계 ID): `333_overfit_guard__timestamp_safe_pocket_veto_materialization`
- status(상태): `closed_no_selection`
- opened_by(개방 실행): `run332F_close_stage332_open_pocket_veto_materialization_stage_v1`
- first_run(첫 실행): `run333A_materialize_timestamp_safe_pocket_veto_features_v1`
...
- closed_by(종료 실행): `run333G_exact_candidate_runtime_handoff_or_preserve_boundary_v1`
