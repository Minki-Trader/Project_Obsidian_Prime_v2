...
- session_parity_runtime_probe_status(세션 동등 런타임 탐침 상태): `blocked_session_parity_runtime_probe_no_completed_mt5_runtime`
- session_parity_runtime_probe_judgment(세션 동등 런타임 탐침 판정): `runtime_probe_blocked_requires_runtime_repair_no_goal_achieve`
