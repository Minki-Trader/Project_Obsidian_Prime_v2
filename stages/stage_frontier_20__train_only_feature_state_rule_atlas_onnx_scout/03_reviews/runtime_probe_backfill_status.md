...
Reason(사유): `runtime_probe_ineligible_no_handoff(주장 경계상 런타임 탐침 부적격, 인계 없음)"}, "compatibility": {"runtime_authority": "not_claimed(주장 없음)", "operating_promotion": "not_claimed(주장 없음)", "mismatch_policy": "fail_fast(즉시 실패)"}, "claim_bo`
