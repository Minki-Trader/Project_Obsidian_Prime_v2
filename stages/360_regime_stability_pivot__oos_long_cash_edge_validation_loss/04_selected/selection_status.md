# Stage360 Selection Status(360단계 선택 상태)

- selection_status(선택 상태): `opened_no_selection(개설됨, 선택 없음)`
- active_stage_id(활성 단계 ID): `360_regime_stability_pivot__oos_long_cash_edge_validation_loss`
...
- source_review_run_id(원천 검토 실행 ID): `run359C_review_high_density_label_pivot_mt5_probe_without_db_v1`
...
## run360B Materialization Closeout(360B 구체화 종료 기록)
