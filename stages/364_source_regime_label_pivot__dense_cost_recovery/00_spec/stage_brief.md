...
- current_run_id(현재 실행 ID): `run364AU_package_threshold_edge_floor001_runtime_probe_without_db_v1`
- latest_completed_run_id(최근 완료 실행 ID): `run364AT_review_threshold_edge_pf_gap_repair_scout_without_db_v1`
...
- selection_status(선택 상태): `completed_stage364AT_proxy_package_candidate_review_runtime_probe_required_no_authority`
