...
- current_run_id(현재 실행 ID): `run364BS_train_late_year_short_share_stress_repair_scout_without_db_v1`
- latest_completed_run_id(최근 완료 실행 ID): `run364BR_review_broad_clean_short_share_lift_scout_without_db_v1`
...
- selection_status(선택 상태): `completed_stage364BR_bq_review_package_rejected_open_bs_no_authority`
