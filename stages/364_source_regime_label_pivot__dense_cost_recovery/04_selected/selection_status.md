...
- current_run(현재 실행): `run364P_materialize_drawdown_side_balance_offensive_inputs_without_db_v1`
- latest_completed_run(최근 완료 실행): `run364O_review_density_lift_trade_shape_onnx_mt5_runtime_probe_without_db_v1`
...
- blockers(차단): drawdown(낙폭) `38.21%`, long/short(롱/숏) `1047/0`, hold tail(보유 꼬리)
