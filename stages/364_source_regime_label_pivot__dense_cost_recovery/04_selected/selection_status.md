...
- current_run(현재 실행): `run364AJ_train_session_side_pf_lift_density_repair_scout_without_db_v1`
- latest_completed_run(최근 완료 실행): `run364AI_materialize_session_side_pf_lift_density_repair_inputs_without_db_v1`
...
- next_scout_queue(다음 정찰 대기열): `stages/364_source_regime_label_pivot__dense_cost_recovery/02_runs/run364AI/run364AJ_scout_queue.csv`
