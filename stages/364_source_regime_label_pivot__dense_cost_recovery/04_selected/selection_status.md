...
- current_run(현재 실행): `run364AW_review_threshold_edge_floor001_mt5_runtime_probe_without_db_v1`
- latest_completed_run(최근 완료 실행): `run364AV_execute_threshold_edge_floor001_mt5_runtime_probe_without_db_v1`
...
- actual_mt5_net_pf_trades(실제 MT5 순수익/수익 팩터/거래수): `878.55` / `1.36` / `971`
- proxy_mt5_diff(프록시 MT5 차이): `16.267` net(순수익), `-94.0` trades(거래수)
