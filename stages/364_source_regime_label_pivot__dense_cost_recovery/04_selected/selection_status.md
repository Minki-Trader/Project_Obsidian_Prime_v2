...
- current_run(현재 실행): `run364AG_train_pf_lift_density_safe_expansion_scout_without_db_v1`
- latest_completed_run(최근 완료 실행): `run364AF_materialize_pf_lift_density_safe_expansion_without_db_v1`
...
- next_scout_queue(다음 정찰 대기열): `stages/364_source_regime_label_pivot__dense_cost_recovery/02_runs/run364AF/run364AG_scout_queue.csv`
