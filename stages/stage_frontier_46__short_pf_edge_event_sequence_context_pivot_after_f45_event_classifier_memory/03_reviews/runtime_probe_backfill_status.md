...
Reason(사유): `runtime_probe_ineligible_no_scout_seed_or_runtime_candidate_after_f45_event_classifier_proxy`.\n- F45 scout/seed/runtime counts(탐색/씨앗/런타임 수): `0/0/0`.\n- F45 best train-ranked row(학습 순위 최상 행): `f45b_0001`, event `event_m`
