...
Reason(사유): `runtime_probe_ineligible_no_seed_or_runtime_candidate_after_f35c_capped_repair`  Next stage(다음 단계): `stage_frontier_36__short_pf_lift_source_change_or_label_pivot_for_seed_surface_onnx_scout`  Next run(다음 실행): `frontier3`
