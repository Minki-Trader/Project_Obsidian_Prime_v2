# Frontier13 Runtime Probe Backfill(전선13 런타임 탐침 소급)
...
|---|---:|---:|---:|---:|---:|---:|
| `validation_is` | `completed` | `completed` | 1.14 | 32.43 | 84 | 0 |
| `oos` | `completed` | `completed` | 4.21 | 8.87 | 13 | 0 |

Candidate(후보): `f13b_vol_squeeze_h12_t1p00_cap0p62_ecap0p36_rec0p12__lr_plain`
