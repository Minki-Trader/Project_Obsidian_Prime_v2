# Frontier04 Runtime Probe Backfill(전선04 런타임 탐침 소급)
...
|---|---:|---:|---:|---:|---:|---:|
| `validation_is` | `completed` | `completed` | 0.88 | 82.16 | 688 | 0 |
| `oos` | `completed` | `completed` | 0.99 | 41.31 | 525 | 0 |

Candidate(후보): `rf_depth5_leaf80_balanced_argmax`
