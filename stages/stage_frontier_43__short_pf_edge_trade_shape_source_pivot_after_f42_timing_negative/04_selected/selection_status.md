...
- stage(단계): `stage_frontier_43__short_pf_edge_trade_shape_source_pivot_after_f42_timing_negative`
- run(실행): `frontier43D_stage_closeout_trade_shape_source_v1`
...
Reason(사유): `runtime_probe_ineligible_no_scout_seed_or_runtime_candidate_after_f43_trade_shape_proxy", "next_stage_id": "stage_frontier_44__short_pf_edge_label_model_pivot_after_f43_trade_shape_negative", "next_run_id": "frontier44A_`
