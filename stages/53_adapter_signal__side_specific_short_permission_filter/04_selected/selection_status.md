...
- adapter_candidate_status(어댑터 후보 상태): `adapter_candidate_observed_user_review_required`
...
- latest_run_id(최신 실행 ID): `run47A_side_specific_short_permission_filter_v1`
