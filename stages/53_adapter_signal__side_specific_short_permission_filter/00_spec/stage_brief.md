# Stage53 Side Permission Filter(53단계 방향 허용 필터)

- idea_id(아이디어 ID): `IDEA-ST53-SIDE-SPECIFIC-SHORT-PERMISSION-FILTER`
- run_id(실행 ID): `run47A_side_specific_short_permission_filter_v1`
- packet_id(패킷 ID): `stage53_run47A_side_specific_short_permission_filter_v1`
