# Frontier05 Runtime Probe Backfill(전선05 런타임 탐침 소급)
...
|---|---:|---:|---:|---:|---:|---:|
| `validation_is` | `completed` | `completed` | 1.14 | 37.83 | 97 | 0 |
| `oos` | `completed` | `completed` | 2.01 | 12.88 | 39 | 0 |

Candidate(후보): `frontier05_reference_v2_only__logreg_l2_c0p5_plain_argmax`
