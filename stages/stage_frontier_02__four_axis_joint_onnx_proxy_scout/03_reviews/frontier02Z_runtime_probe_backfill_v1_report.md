# Frontier02 Runtime Probe Backfill(전선02 런타임 탐침 소급)
...
|---|---:|---:|---:|---:|---:|---:|
| `validation_is` | `completed` | `completed` | 1.21 | 20.88 | 432 | 0 |
| `oos` | `completed` | `completed` | 0.99 | 46.15 | 328 | 0 |

Candidate(후보): `frontier02c_logreg_teacher__trend_follow_joint__mid_cash__both__q70__cd6__p34__m0__cd6`
Decision mode(결정 방식): `threshold_margin`
