...
Reason(사유): `runtime_probe_ineligible_no_handoff_candidate_after_f29c_repair_decision`  ONNX blocker(ONNX 차단 사유): `onnx_branch_unattempted_no_handoff_candidate_after_f29c_repair_decision`  Next action(다음 행동): `frontier30A_stage_open_`
