# Frontier14 Runtime Probe Backfill(전선14 런타임 탐침 소급)
...
|---|---:|---:|---:|---:|---:|---:|
| `validation_is` | `completed` | `completed` | 1.23 | 11.73 | 7 | 0 |
| `oos` | `completed` | `completed` | 4.97 | 4.32 | 5 | 0 |

Candidate(후보): `f14b_cash_q8_h8__flat8x_safest__lr_plain`
