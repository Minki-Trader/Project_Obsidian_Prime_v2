...
- stage_status(단계 상태): `run267CO_pool_wide_shared_weakness_breakout_mt5_batch_completed`
- current_packet(현재 작업 묶음): `stage267_baseline_candidate_racing_protocol_v1`
- current_run(현재 실행): `run267CO_stage267_pool_wide_shared_weakness_breakout_mt5_execution_v1`
- last_completed_run(마지막 완료 실행): `run267CO_stage267_pool_wide_shared_weakness_breakout_mt5_execution_v1`
