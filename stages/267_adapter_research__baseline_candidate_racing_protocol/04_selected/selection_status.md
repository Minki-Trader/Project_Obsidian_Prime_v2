...
- stage_status(단계 상태): `run267AB_noncalendar_weak_slice_resilience_queue_materialized`
...
- last_completed_run(마지막 완료 실행): `run267AB_stage267_noncalendar_weak_slice_resilience_queue_v1`
