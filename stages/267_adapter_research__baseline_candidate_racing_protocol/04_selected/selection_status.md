...
- stage_status(단계 상태): `run267BT_pool_wide_directional_impulse_followup_mt5_batch_completed`
- current_packet(현재 작업 묶음): `stage267_baseline_candidate_racing_protocol_v1`
- current_run(현재 실행): `run267BT_stage267_pool_wide_directional_impulse_followup_mt5_execution_v1`
- last_completed_run(마지막 완료 실행): `run267BT_stage267_pool_wide_directional_impulse_followup_mt5_execution_v1`
...
- adapter_under_review(검토 중 어댑터): `pool_wide_directional_impulse_followup_mt5_execution`
