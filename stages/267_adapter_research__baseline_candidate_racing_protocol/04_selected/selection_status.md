...
- stage_status(단계 상태): `run267EN_runtime_gap_aware_tenth_followup_or_prune_design_completed`
...
- last_completed_run(마지막 완료 실행): `run267EN_stage267_runtime_gap_aware_tenth_followup_or_prune_design_v1`
