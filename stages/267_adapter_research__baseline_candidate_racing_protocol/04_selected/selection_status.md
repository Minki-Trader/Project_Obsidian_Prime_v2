...
- stage_status(단계 상태): `run267B_input_readiness_materialized_next_execution_pending`
...
Run267B(267B 실행)는 실행 결과(run result, 실행 결과)가 아니라 입력 준비(input readiness, 입력 준비)를 완료했다.
