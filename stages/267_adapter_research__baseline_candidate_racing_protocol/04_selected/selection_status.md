...
- stage_status(단계 상태): `run267B_equity_curve_shape_grading_completed_partial_next_execution_pending`
...
Run267B(267B 실행)는 input readiness(입력 준비)와 first-pass equity curve shape grading(1차 평가금 곡선 형태 판정)을 완료했다.
