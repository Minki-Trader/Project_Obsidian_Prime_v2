...
- current_run(현재 실행): `run267DK_stage267_shared_weakness_breakout_third_followup_or_prune_design_v1`
- last_completed_run(마지막 완료 실행): `run267DK_stage267_shared_weakness_breakout_third_followup_or_prune_design_v1`
