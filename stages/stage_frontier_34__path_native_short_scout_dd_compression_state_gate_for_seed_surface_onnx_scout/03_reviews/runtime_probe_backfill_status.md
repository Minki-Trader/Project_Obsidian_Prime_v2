...
Reason(사유): `runtime_probe_ineligible_no_seed_or_runtime_candidate_after_f34c_capped_repair`  Next stage(다음 단계): `stage_frontier_35__dd_compressed_short_state_pf_source_lift_for_seed_surface_onnx_scout`  Next run(다음 실행): `frontier35A`
