# Frontier12 Runtime Probe Backfill(전선12 런타임 탐침 소급)
...
|---|---:|---:|---:|---:|---:|---:|
| `validation_is` | `completed` | `completed` | 1.04 | 29.98 | 119 | 0 |
| `oos` | `completed` | `completed` | 1.71 | 13.55 | 28 | 0 |

Candidate(후보): `f12b_fast_shape_h6_e2_t0p72_cap0p42_ecap0p24_rec0p08__lr_plain`
