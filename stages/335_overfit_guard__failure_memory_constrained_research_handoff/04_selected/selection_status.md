...
- latest_design(최신 설계): `run335A_design_failure_memory_constrained_research_packet_v1`
...
- next_action(다음 행동): `run335C_design_guarded_failure_memory_research_branches_v1`
