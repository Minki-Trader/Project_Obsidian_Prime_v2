# run13K_ebm_q90_hold10_probe_v1 Result Summary(run13K 결과 요약)

- topic read(주제 판독): `q90_hold10_trade_shape_stress`
- selected variant(선택 변형): `v01_main_effects_broad_bins`
- threshold(임계값): `q0.90`
- max hold bars(최대 보유 봉): `10`
- judgment(판정): `inconclusive_ebm_q90_hold10_runtime_probe_completed`
...
|---|---:|---:|---:|---:|---:|
| validation(검증) | `-149.25` | `0.89` | `255` | `481.85` | `-0.31` |
| OOS(표본외) | `-46.5` | `0.95` | `199` | `272.48` | `-0.17` |
