# run13N_ebm_q90_hold4_top5_mask_probe_v1 Result Summary(run13N 결과 요약)

- topic read(주제 판독): `q90_hold4_top5_feature_mask_runtime`
- selected variant(선택 변형): `v01_main_effects_broad_bins`
- threshold(임계값): `q0.90`
- max hold bars(최대 보유 봉): `4`
- judgment(판정): `inconclusive_ebm_q90_hold4_top5_feature_mask_runtime_probe_completed`
...
|---|---:|---:|---:|---:|---:|
| validation(검증) | `174.76` | `1.25` | `243` | `144.81` | `1.21` |
| OOS(표본외) | `-90.4` | `0.79` | `141` | `147.19` | `-0.61` |
