# run13B_ebm_q90_runtime_handoff_probe_v1 Result Summary(run13B 결과 요약)

- topic read(주제 판독): `q90_runtime_handoff_feasibility`
- selected variant(선택 변형): `v01_main_effects_broad_bins`
- threshold(임계값): `q0.90`
- max hold bars(최대 보유 봉): `12`
- judgment(판정): `inconclusive_ebm_q90_runtime_handoff_probe_completed`
...
|---|---:|---:|---:|---:|---:|
| validation(검증) | `-84.61` | `0.93` | `234` | `380.54` | `-0.22` |
| OOS(표본외) | `-52.24` | `0.95` | `191` | `283.28` | `-0.18` |
