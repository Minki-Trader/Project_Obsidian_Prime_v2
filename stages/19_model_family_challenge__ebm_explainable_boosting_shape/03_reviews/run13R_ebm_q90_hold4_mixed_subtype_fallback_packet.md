# run13R_ebm_q90_hold4_mixed_subtype_fallback_probe_v1 Result Summary(run13R 결과 요약)

- topic read(주제 판독): `q90_hold4_b_mixed_partial_context_fallback_only_filter`
- selected variant(선택 변형): `v01_main_effects_broad_bins`
- threshold(임계값): `q0.90`
- max hold bars(최대 보유 봉): `4`
- judgment(판정): `inconclusive_ebm_q90_hold4_b_mixed_partial_context_fallback_filter_runtime_probe_completed`
...
|---|---:|---:|---:|---:|---:|
| validation(검증) | `-115.97` | `0.92` | `366` | `350.12` | `-0.33` |
| OOS(표본외) | `143.94` | `1.18` | `287` | `83.67` | `1.72` |
