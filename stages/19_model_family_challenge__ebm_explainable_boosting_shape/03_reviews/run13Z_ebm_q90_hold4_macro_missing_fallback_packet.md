# run13Z_ebm_q90_hold4_macro_missing_fallback_probe_v1 Result Summary(run13Z 결과 요약)

- topic read(주제 판독): `q90_hold4_b_macro_missing_fallback_filter`
- selected variant(선택 변형): `v01_main_effects_broad_bins`
- threshold(임계값): `q0.90`
- max hold bars(최대 보유 봉): `4`
- judgment(판정): `inconclusive_ebm_q90_hold4_b_macro_missing_fallback_filter_runtime_probe_completed`
...
|---|---:|---:|---:|---:|---:|
| validation(검증) | `-107.7` | `0.92` | `370` | `347.39` | `-0.31` |
| OOS(표본외) | `120.31` | `1.15` | `283` | `83.88` | `1.43` |
