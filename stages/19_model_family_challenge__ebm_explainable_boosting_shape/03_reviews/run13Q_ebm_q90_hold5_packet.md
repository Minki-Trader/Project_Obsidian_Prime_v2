# run13Q_ebm_q90_hold5_probe_v1 Result Summary(run13Q 결과 요약)

- topic read(주제 판독): `q90_hold5_trade_shape_stress`
- selected variant(선택 변형): `v01_main_effects_broad_bins`
- threshold(임계값): `q0.90`
- max hold bars(최대 보유 봉): `5`
- judgment(판정): `inconclusive_ebm_q90_hold5_runtime_probe_completed`
...
|---|---:|---:|---:|---:|---:|
| validation(검증) | `-163.98` | `0.88` | `336` | `436.29` | `-0.38` |
| OOS(표본외) | `0.7` | `1.0` | `271` | `216.59` | `0.0` |
