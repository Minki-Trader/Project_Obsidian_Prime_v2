# run13J_ebm_q90_hold8_probe_v1 Result Summary(run13J 결과 요약)

- topic read(주제 판독): `q90_hold8_trade_shape_stress`
- selected variant(선택 변형): `v01_main_effects_broad_bins`
- threshold(임계값): `q0.90`
- max hold bars(최대 보유 봉): `8`
- judgment(판정): `inconclusive_ebm_q90_hold8_runtime_probe_completed`
...
|---|---:|---:|---:|---:|---:|
| validation(검증) | `-177.13` | `0.87` | `278` | `445.38` | `-0.4` |
| OOS(표본외) | `8.28` | `1.01` | `220` | `216.52` | `0.04` |
