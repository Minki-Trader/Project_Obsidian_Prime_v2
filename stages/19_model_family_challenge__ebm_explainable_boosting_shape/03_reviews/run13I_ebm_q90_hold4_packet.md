# run13I_ebm_q90_hold4_probe_v1 Result Summary(run13I 결과 요약)

- topic read(주제 판독): `q90_hold4_trade_shape_stress`
- selected variant(선택 변형): `v01_main_effects_broad_bins`
- threshold(임계값): `q0.90`
- max hold bars(최대 보유 봉): `4`
- judgment(판정): `inconclusive_ebm_q90_hold4_runtime_probe_completed`
...
|---|---:|---:|---:|---:|---:|
| validation(검증) | `-107.72` | `0.92` | `372` | `346.66` | `-0.31` |
| OOS(표본외) | `134.3` | `1.17` | `292` | `84.07` | `1.6` |
