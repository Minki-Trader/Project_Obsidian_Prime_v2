# run13O_ebm_q90_hold2_probe_v1 Result Summary(run13O 결과 요약)

- topic read(주제 판독): `q90_hold2_trade_shape_stress`
- selected variant(선택 변형): `v01_main_effects_broad_bins`
- threshold(임계값): `q0.90`
- max hold bars(최대 보유 봉): `2`
- judgment(판정): `inconclusive_ebm_q90_hold2_runtime_probe_completed`
...
|---|---:|---:|---:|---:|---:|
| validation(검증) | `69.53` | `1.06` | `498` | `295.93` | `0.23` |
| OOS(표본외) | `25.69` | `1.03` | `383` | `104.71` | `0.25` |
