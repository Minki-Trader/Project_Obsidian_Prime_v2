# run13P_ebm_q90_hold3_probe_v1 Result Summary(run13P 결과 요약)

- topic read(주제 판독): `q90_hold3_trade_shape_stress`
- selected variant(선택 변형): `v01_main_effects_broad_bins`
- threshold(임계값): `q0.90`
- max hold bars(최대 보유 봉): `3`
- judgment(판정): `inconclusive_ebm_q90_hold3_runtime_probe_completed`
...
|---|---:|---:|---:|---:|---:|
| validation(검증) | `-95.92` | `0.92` | `423` | `326.75` | `-0.29` |
| OOS(표본외) | `-125.87` | `0.87` | `327` | `182.56` | `-0.69` |
