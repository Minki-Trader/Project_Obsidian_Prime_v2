# Stage19 Review Index(19단계 검토 색인)

- `run13A_ebm_main_effect_shape_scout_v1`: `stages/19_model_family_challenge__ebm_explainable_boosting_shape/03_reviews/run13A_ebm_shape_scout_packet.md`
