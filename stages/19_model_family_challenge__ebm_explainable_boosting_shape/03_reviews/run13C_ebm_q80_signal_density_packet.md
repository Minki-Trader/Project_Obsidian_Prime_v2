# run13C_ebm_q80_signal_density_probe_v1 Result Summary(run13C 결과 요약)

- topic read(주제 판독): `q80_signal_density_pressure`
- selected variant(선택 변형): `v01_main_effects_broad_bins`
- threshold(임계값): `q0.80`
- max hold bars(최대 보유 봉): `12`
- judgment(판정): `inconclusive_ebm_q80_signal_density_runtime_probe_completed`
...
|---|---:|---:|---:|---:|---:|
| validation(검증) | `163.75` | `1.09` | `422` | `240.46` | `0.68` |
| OOS(표본외) | `-360.74` | `0.79` | `348` | `480.5` | `-0.75` |
