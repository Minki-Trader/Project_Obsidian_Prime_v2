# run13W_ebm_q90_hold4_mask_ema50_ema200_probe_v1 Result Summary(run13W 결과 요약)

- topic read(주제 판독): `q90_hold4_single_feature_mask_ema50_ema200_diff`
- selected variant(선택 변형): `v01_main_effects_broad_bins`
- threshold(임계값): `q0.90`
- max hold bars(최대 보유 봉): `4`
- judgment(판정): `inconclusive_ebm_q90_hold4_single_feature_mask_ema50_ema200_diff_runtime_probe_completed`
...
|---|---:|---:|---:|---:|---:|
| validation(검증) | `62.08` | `1.05` | `353` | `155.05` | `0.4` |
| OOS(표본외) | `-269.11` | `0.72` | `276` | `320.48` | `-0.84` |
