# run13Y_ebm_q90_hold4_mask_hl_zscore_probe_v1 Result Summary(run13Y 결과 요약)

- topic read(주제 판독): `q90_hold4_single_feature_mask_hl_zscore_50`
- selected variant(선택 변형): `v01_main_effects_broad_bins`
- threshold(임계값): `q0.90`
- max hold bars(최대 보유 봉): `4`
- judgment(판정): `inconclusive_ebm_q90_hold4_single_feature_mask_hl_zscore_50_runtime_probe_completed`
...
|---|---:|---:|---:|---:|---:|
| validation(검증) | `-42.09` | `0.97` | `399` | `335.81` | `-0.13` |
| OOS(표본외) | `42.57` | `1.05` | `315` | `94.13` | `0.45` |
