# run13X_ebm_q90_hold4_mask_ema20_ema50_probe_v1 Result Summary(run13X 결과 요약)

- topic read(주제 판독): `q90_hold4_single_feature_mask_ema20_ema50_diff`
- selected variant(선택 변형): `v01_main_effects_broad_bins`
- threshold(임계값): `q0.90`
- max hold bars(최대 보유 봉): `4`
- judgment(판정): `inconclusive_ebm_q90_hold4_single_feature_mask_ema20_ema50_diff_runtime_probe_completed`
...
|---|---:|---:|---:|---:|---:|
| validation(검증) | `-137.39` | `0.89` | `372` | `257.09` | `-0.53` |
| OOS(표본외) | `4.3` | `1.01` | `288` | `99.66` | `0.04` |
