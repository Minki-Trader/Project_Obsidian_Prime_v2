# run13V_ebm_q90_hold4_mask_ema9_ema20_probe_v1 Result Summary(run13V 결과 요약)

- topic read(주제 판독): `q90_hold4_single_feature_mask_ema9_ema20_diff`
- selected variant(선택 변형): `v01_main_effects_broad_bins`
- threshold(임계값): `q0.90`
- max hold bars(최대 보유 봉): `4`
- judgment(판정): `inconclusive_ebm_q90_hold4_single_feature_mask_ema9_ema20_diff_runtime_probe_completed`
...
|---|---:|---:|---:|---:|---:|
| validation(검증) | `178.41` | `1.15` | `388` | `208.42` | `0.86` |
| OOS(표본외) | `32.63` | `1.04` | `304` | `105.58` | `0.31` |
