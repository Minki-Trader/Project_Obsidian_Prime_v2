# run13D_ebm_q95_sparse_tail_probe_v1 Result Summary(run13D 결과 요약)

- topic read(주제 판독): `q95_sparse_tail_extreme`
- selected variant(선택 변형): `v01_main_effects_broad_bins`
- threshold(임계값): `q0.95`
- max hold bars(최대 보유 봉): `12`
- judgment(판정): `inconclusive_ebm_q95_sparse_tail_runtime_probe_completed`
...
|---|---:|---:|---:|---:|---:|
| validation(검증) | `237.61` | `1.35` | `135` | `176.65` | `1.35` |
| OOS(표본외) | `-151.86` | `0.75` | `101` | `265.63` | `-0.57` |
