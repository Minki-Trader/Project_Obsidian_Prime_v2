...
RUN_NUMBER = "run50T"
PARENT_RUN_ID = "run50T_stage56_nonflat_vol_low_hold_compression_v1"
PACKET_ID = "stage56_run50T_nonflat_vol_low_hold_compression_v1"
EXPLORATION_LABEL = "stage56_BaseEngine__NonflatVolLowHoldCompression"
STAGE_ROOT = batch.STAGE_ROOT
RUN_ROOT = STAGE_ROOT / "02_runs" / RUN_NUMBER
REVIEWS_ROOT = batch.REVIEWS_ROOT
REPORT_PATH = REVIEWS_ROOT / "run50T_reopen_batch.md"
RESULTS_CSV_PATH = REVIEWS_ROOT / "run50T_summary.csv"
AUDIT_CSV_PATH = REVIEWS_ROOT / "run50T_audit.csv"
...
DEFAULT_VARIANTS: tuple[batch.ModelAxisVariant, ...] = (
    _variant(
        "nf_vollow_h08_s350l240_a",
        "nf_vollow_h08_s350l240",
        "nonflat_vol_low_hold8_aonly",
        0.350,
        0.240,
        8,
        routed_fallback_enabled=False,
        notes="hold8 compression after vol_low block; Tier B disabled comparison",
    ),
    _variant(
        "nf_vollow_h08_s350l240_b",
        "nf_vollow_h08_s350l240",
        "nonflat_vol_low_hold8_tier_b_comparison",
        0.350,
        0.240,
        8,
        routed_fallback_enabled=True,
        notes="hold8 compression after vol_low block; B045 fallback",
    ),
    _variant(
        "nf_vollow_h08_s340l230_b",
        "nf_vollow_h08_s340l230",
        "nonflat_vol_low_hold8_density_pressure",
        0.340,
        0.230,
        8,
        routed_fallback_enabled=True,
        notes="hold8 density pressure after vol_low block; B045 fallback",
    ),
    _variant(
        "nf_vollow_h06_s350l240_a",
        "nf_vollow_h06_s350l240",
        "nonflat_vol_low_hold6_aonly",
        0.350,
        0.240,
        6,
        routed_fallback_enabled=False,
        notes="hold6 compression after vol_low block; Tier B disabled comparison",
    ),
    _variant(
        "nf_vollow_h06_s350l240_b",
        "nf_vollow_h06_s350l240",
        "nonflat_vol_low_hold6_tier_b_comparison",
        0.350,
        0.240,
        6,
        routed_fallback_enabled=True,
        notes="hold6 compression after vol_low block; B045 fallback",
    ),
    _variant(
        "nf_vollow_h06_s340l230_b",
        "nf_vollow_h06_s340l230",
        "nonflat_vol_low_hold6_density_pressure",
        0.340,
        0.230,
        6,
        routed_fallback_enabled=True,
        notes="hold6 density pressure after vol_low block; B045 fallback",
    ),
)
