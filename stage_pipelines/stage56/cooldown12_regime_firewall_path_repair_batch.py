...
RUN_NUMBER = "run50AD"
PARENT_RUN_ID = "run50AD_stage56_c12_rf_path_repair_v1"
PACKET_ID = "stage56_run50AD_c12_rf_path_repair_v1"
EXPLORATION_LABEL = "stage56_BaseEngine__C12RegimeFirewallPathRepair"
STAGE_ROOT = batch.STAGE_ROOT
RUN_ROOT = STAGE_ROOT / "02_runs" / RUN_NUMBER
REVIEWS_ROOT = batch.REVIEWS_ROOT
REPORT_PATH = REVIEWS_ROOT / "run50AD_reopen_batch.md"
RESULTS_CSV_PATH = REVIEWS_ROOT / "run50AD_summary.csv"
AUDIT_CSV_PATH = REVIEWS_ROOT / "run50AD_audit.csv"
...
def _adx2025_variant(
    ...
    *,
    ...
    return _variant(
        ...
        side_filter_id="c12_buy_adx2025",
        block_long_min=20.0,
        block_long_max=25.0,
        routed_fallback_enabled=routed_fallback_enabled,
        notes=notes,
...
DEFAULT_VARIANTS: tuple[batch.ModelAxisVariant, ...] = (
    _vol_low_variant(
        "lv26a",
        "lv26",
        "c12_buy_vol_low_firewall_aonly",
        0.260,
        0.170,
        routed_fallback_enabled=False,
        notes="path repair of run50AC: block buy vol_low damage under actual 12-bar cooldown and hold8",
    ),
    _vol_low_variant(
        "lv26b",
        "lv26",
        "c12_buy_vol_low_firewall_tier_b_comparison",
        0.260,
        0.170,
        routed_fallback_enabled=True,
        notes="path repair matched A+B comparison for buy vol_low firewall",
    ),
    _vol_low_variant(
        "lv24a",
        "lv24",
        "c12_buy_vol_low_density_aonly",
        0.240,
        0.150,
        routed_fallback_enabled=False,
        notes="path repair density pressure after buy vol_low firewall",
    ),
    _vol_low_variant(
        "lv24b",
        "lv24",
        "c12_buy_vol_low_density_tier_b_comparison",
        0.240,
        0.150,
        routed_fallback_enabled=True,
        notes="path repair matched A+B density comparison after buy vol_low firewall",
    ),
    _adx2025_variant(
        "ax26a",
        "ax26",
        "c12_buy_adx20_25_firewall_aonly",
        0.260,
        0.170,
        routed_fallback_enabled=False,
        notes="path repair: block only buy ADX 20-25 damage and preserve high-ADX buy opportunities",
    ),
    _adx2025_variant(
        "ax26b",
        "ax26",
        "c12_buy_adx20_25_firewall_tier_b_comparison",
        0.260,
        0.170,
        routed_fallback_enabled=True,
        notes="path repair matched A+B comparison for buy ADX 20-25 firewall",
    ),
    _downtrend_variant(
        "dn26a",
        "dn26",
        "c12_buy_downtrend_firewall_aonly",
        0.260,
        0.170,
        routed_fallback_enabled=False,
        notes="path repair stress test of OOS buy downtrend damage under actual 12-bar cooldown",
    ),
    _downtrend_variant(
        "dn26b",
        "dn26",
        "c12_buy_downtrend_firewall_tier_b_comparison",
        0.260,
        0.170,
        routed_fallback_enabled=True,
        notes="path repair matched A+B comparison for buy downtrend firewall",
    ),
)
