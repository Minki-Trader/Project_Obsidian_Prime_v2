...
SOURCE_STAGE59B_ID = "59B_adapter_repair__model_source_or_backup_branch"
STAGE59_ID = "59C_adapter_repair__new_model_source_branch"
NEXT_REPAIR_STAGE_ID = "59D_adapter_repair__source_lifecycle_or_demote"
RUN_NUMBER = "run56A"
RUN_ID = "run56A_stage59c_new_model_source_branch_v1"
PACKET_ID = "stage59c_new_model_source_branch_v1"
PARENT_RUN_ID = "run55A_stage59b_model_source_or_backup_branch_v1"
...
S43_RUN_ROOT = SOURCE_STAGE_ROOT / "02_runs/run50BK"
S43_MODEL = S43_RUN_ROOT / "models/stage43_stage43_low_complexity_signal_discrete_signal_score_table.csv"
SOURCE_STAGE59B_ROOT = Path("stages") / SOURCE_STAGE59B_ID
SOURCE_STAGE59B_DECISION = SOURCE_STAGE59B_ROOT / "03_reviews/stage59b_decision.md"
SOURCE_STAGE59B_REPORT = SOURCE_STAGE59B_ROOT / "03_reviews/model_source_or_backup_branch_report.md"
SOURCE_STAGE59B_SUMMARY = SOURCE_STAGE59B_ROOT / "03_reviews/model_source_or_backup_branch_summary.csv"
SOURCE_STAGE59B_SEGMENTS = SOURCE_STAGE59B_ROOT / "03_reviews/model_source_or_backup_segment_kpi_summary.csv"
SOURCE_STAGE59B_RISK = SOURCE_STAGE59B_ROOT / "03_reviews/model_source_or_backup_risk_atr_telemetry.csv"

DEVELOPMENT_SIGNAL_COLUMN = "stage56_context_gap_refill_signal"
BACKUP_SIGNAL_COLUMN = "stage56_context_et_firewall_signal"
S43_SIGNAL_COLUMN = "stage43_low_complexity_signal"
COMMON_ROOT = f"Project_Obsidian_Prime_v2/stage59c/{RUN_NUMBER}_new_model_source_branch"

REPORT_PATH = REVIEWS_ROOT / "new_model_source_branch_report.md"
SUMMARY_JSON_PATH = REVIEWS_ROOT / "new_model_source_branch_summary.json"
SUMMARY_CSV_PATH = REVIEWS_ROOT / "new_model_source_branch_summary.csv"
SEGMENT_KPI_PATH = REVIEWS_ROOT / "new_model_source_segment_kpi_summary.csv"
EQUITY_AUDIT_PATH = REVIEWS_ROOT / "new_model_source_equity_curve_audit.md"
RISK_ATR_TELEMETRY_PATH = REVIEWS_ROOT / "new_model_source_risk_atr_telemetry.csv"
DECISION_PATH = REVIEWS_ROOT / "stage59c_decision.md"
AUDIT_CSV_PATH = REVIEWS_ROOT / "stage59c_trade_audit.csv"
...
STAGE59B_PUSHED_COMMIT = "a1e03cfdd719a93288279850ddc3600d63b06396"

STAGE59_VARIANTS = (
    repair.RepairVariant(
        adapter_id="s59c_v64_control_thr57_mr03_wideatr_sd5",
        ...
        long_threshold=0.57,
        notes="Stage59C bounded control: v64 source with Stage59A/59B best threshold, 3% model-controlled risk cap, and wide ATR.",
    ),
    repair.RepairVariant(
        adapter_id="s59c_s43_no_b_thr55_mr03_wideatr_sd5",
        label="s43_no_b_threshold55_risk3pct_wide_atr_sd5",
        atr_enabled=True,
        model_risk_enabled=True,
        fixed_lot=0.25,
        atr_stop_multiplier=2.5,
        ...
        short_threshold=0.55,
        long_threshold=0.55,
        notes="Stage59C bounded new model source branch: Stage43 no-B source with native 0.55 threshold, 3% model-controlled risk cap, and wide ATR.",
    ),
    repair.RepairVariant(
        adapter_id="s59c_s43_with_b_blvl_thr55_mr03_wideatr_sd5",
        label="s43_with_b_blvl_threshold55_risk3pct_wide_atr_sd5",
        atr_enabled=True,
        model_risk_enabled=True,
        fixed_lot=0.25,
        atr_stop_multiplier=2.5,
        ...
        short_threshold=0.55,
        long_threshold=0.55,
        notes="Stage59C bounded new model source branch: Stage43 with-B B-level source, Tier B disabled in this adapter test, 3% model-controlled risk cap, and wide ATR.",
    ),
)
...
SOURCE_SPECS: dict[str, dict[str, Any]] = {
    "s59c_v64_control_thr57_mr03_wideatr_sd5": {
        "label": "control_v64",
    ...
    "s59c_s43_no_b_thr55_mr03_wideatr_sd5": {
        "label": "s43_no_b",
        "run_root": S43_RUN_ROOT,
        "variant_root": S43_RUN_ROOT / "s43c02_h4c0_no_b",
        "anchor": "s43c02_h4c0_no_b",
        "model": S43_MODEL,
        "signal_column": S43_SIGNAL_COLUMN,
        "validation_ini": S43_RUN_ROOT / "s43c02_h4c0_no_b/mt5/s43c02_h4c0_no_b_tier_a_only_validation_is.ini",
        "oos_ini": S43_RUN_ROOT / "s43c02_h4c0_no_b/mt5/s43c02_h4c0_no_b_tier_a_only_oos.ini",
        "source_note": "Stage43 low-complexity no-B source",
    },
    "s59c_s43_with_b_blvl_thr55_mr03_wideatr_sd5": {
        "label": "s43_with_b_blvl",
        "run_root": S43_RUN_ROOT,
        "variant_root": S43_RUN_ROOT / "s43c02_h4c0_with_b_blvl",
        "anchor": "s43c02_h4c0_with_b_blvl",
        "model": S43_MODEL,
        "signal_column": S43_SIGNAL_COLUMN,
        "validation_ini": S43_RUN_ROOT / "s43c02_h4c0_with_b_blvl/mt5/s43c02_h4c0_with_b_blvl_tier_a_only_validation_is.ini",
        "oos_ini": S43_RUN_ROOT / "s43c02_h4c0_with_b_blvl/mt5/s43c02_h4c0_with_b_blvl_tier_a_only_oos.ini",
        "source_note": "Stage43 low-complexity with-B B-level source, tested here with Tier B disabled",
    },
}
...
def source_spec_for_variant(variant: repair.RepairVariant | str) -> dict[str, Any]:
    ...
    try:
        ...
        raise KeyError(f"Missing Stage59C source spec for {adapter_id}") from exc
...
def prepare_inputs(common_files_root: Path) -> dict[str, Any]:
    ...
    for variant in STAGE59_VARIANTS:
        ...
        for split in ("validation_is", "oos"):
            ...
            feature_local = RUN_ROOT / variant.adapter_id / "features" / f"{variant.adapter_id}_stage59c_adapter_a_{token}.csv"
    ...
    for variant_index, variant in enumerate(STAGE59_VARIANTS, start=1):
        ...
        for split in ("validation_is", "oos"):
            ...
            for role_index, (tier, attempt_role, prefix, attempt_token) in enumerate(
                ...
                magic = 5905600 + variant_index * 100 + (1 if split == "validation_is" else 50) + role_index
                attempts.append(
                    attempt_payload(
                        run_root=variant_root,
                        run_id=RUN_ID,
                        stage_number=59,
                        exploration_label="stage59C_BaselineAdapter__NewModelSourceBranch",
...
def load_existing_result() -> dict[str, Any]:
    ...
    if not path_exists(manifest) or not path_exists(kpi):
        raise FileNotFoundError("Stage59C existing run_manifest.json or kpi_record.json is missing")
...
def repair_failure_reasons(summary_rows: Sequence[Mapping[str, Any]], segment_rows: Sequence[Mapping[str, Any]]) -> list[str]:
    ...
    if blocked_or_missing:
        reasons.append("stage59c_source_variant_missing_or_blocked")
            ...
            rows.append(
                {
                    ...
                    "stage_id": STAGE59_ID,
                    "run_id": RUN_ID,
                    "artifact_type": "stage59c_new_model_source_evidence",
                    "path": rel(path),
                    "sha256": sha256_file_lf_normalized(path),
                    "hash_policy": "lf_normalized_text" if path.suffix.lower() in {".csv", ".json", ".md"} else "raw_file",
                    "created_at_utc": created,
                    "notes": "Stage59C bounded new model source branch artifact.",
                }
            )
            ...
            rows.append(
                {
                    ...
                    "created_at_utc": created,
                    "notes": "Actual Stage59C MT5 Strategy Tester HTML report.",
                }
            )
    return rows
...
def write_run_identity(result: Mapping[str, Any]) -> None:
    write_json(
        RUN_ROOT / "run_manifest.json",
        {
            ...
            "bounded_question": "Can a new model source branch repair the remaining post-Stage59B weakness without starting ONNX?",
            "source_stage59b_decision": rel(SOURCE_STAGE59B_DECISION),
...
def write_ledgers(
        ...
        [
            {
                "run_id": RUN_ID,
                "stage_id": STAGE59_ID,
                "lane": "baseline_adapter_new_model_source_branch",
                "status": status,
                "judgment": decision,
    ...
    ledger_rows.append(
        {
            "ledger_row_id": f"{RUN_ID}__aggregate_new_model_source_branch",
            "stage_id": STAGE59_ID,
            "run_id": RUN_ID,
            "subrun_id": "aggregate_new_model_source_branch",
            "parent_run_id": PARENT_RUN_ID,
            "record_view": "new_model_source_branch",
            "tier_scope": "Tier A+B",
            ...
            "external_verification_status": external,
            "notes": "Stage59C bounded new model source branch; not final package completion.",
        }
    )
...
def report_markdown(summary_rows: Sequence[Mapping[str, Any]], decision: str, reasons: Sequence[str], external: str) -> str:
    ...
    best = best_repaired_variant(summary_rows)
    return f"""# Stage59C New Model Source Branch Report(59C단계 새 모델 원천 분기 보고서)

- stage(단계): `{STAGE59_ID}`
- run(실행): `{RUN_ID}`
- source_adapter(원천 어댑터): `{SOURCE_ADAPTER_ID}`
- source_stage59b_commit(원천 59B단계 커밋): `{STAGE59B_PUSHED_COMMIT}`
...
def equity_audit_markdown(summary_rows: Sequence[Mapping[str, Any]], segment_rows: Sequence[Mapping[str, Any]]) -> str:
    ...
    return f"""# Stage59C New Model Source Equity Curve Audit(59C단계 새 모델 원천 자금 곡선 감사)
...
def decision_markdown(decision: str, reasons: Sequence[str], best: Mapping[str, Any], external: str) -> str:
    return f"""# Stage59C Decision(59C단계 판정)
    ...
    write_json(
        SUMMARY_JSON_PATH,
        {
            ...
            "required_outputs": {
                ...
                "stage59c_decision": rel(DECISION_PATH),
            },
...
def write_packet_files(
    ...
    files = {
        ...
        "experiment_design_receipt.json": {
            "hypothesis": "Changing to a Stage43 new model source may repair the remaining Stage59B validation cost-stressed weakness while preserving ATR bracket and model-controlled risk behavior",
            ...
            "comparison_baseline": "Stage59B best adapter s59b_v64_control_thr57_mr03_wideatr_sd5",
            "control_variables": ["US100", "M5", "split_v1", "Tier B disabled", "wide ATR bracket", "3% model-controlled risk cap", "ONNX deferred"],
            "changed_variables": ["feature source anchor", "signal column", "source family"],
            ...
            "stop_condition": "three bounded Stage59C variants only",
            "status": "completed",
        },
        ...
        "artifact_lineage_audit.json": {
            "source_inputs": [rel(SOURCE_STAGE59B_DECISION), rel(SOURCE_STAGE59B_REPORT), rel(SOURCE_MODEL), rel(S43_MODEL)],
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Stage59C bounded new model source branch.")
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.finalize_existing:
        ...
        prepared = {
            ...
            "model_family": "baseline_adapter_stage59c_new_model_source_ebm_table",
            "feature_set_id": "stage59c_v64_control_or_s43_new_source_signal",
