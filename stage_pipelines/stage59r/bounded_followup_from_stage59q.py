...
SOURCE_STAGE59Q_ID = "59Q_adapter_repair__bounded_followup_from_stage59p"
STAGE59R_ID = "59R_adapter_repair__bounded_followup_from_stage59q"
NEXT_REPAIR_STAGE_ID = "59S_adapter_repair__bounded_followup_from_stage59r"
RUN_NUMBER = "run59M"
RUN_ID = "run59M_stage59r_bounded_followup_from_stage59q_v1"
PACKET_ID = "stage59r_bounded_followup_from_stage59q_v1"
PARENT_RUN_ID = "run59L_stage59q_bounded_followup_from_stage59p_v1"
SOURCE_ADAPTER_ID = "s59q_v62_sl20_tp30_sd12_h5_rearm002"
DEVELOPMENT_ANCHOR = "v64_v47_ctxgap14_refill_etfw_h2_no_b"
BACKUP_ANCHOR = "v60_v47_et_stable_damage_firewall_h2c0_no_b"
SOURCE_STAGE59Q_PUSHED_COMMIT = "eb6fe2087becd84697dcc9967ce4477c5623e08a"
BOUNDARY = (
    "research_development_only_no_live_readiness_no_runtime_authority_"
    "no_operating_promotion_no_operating_reference_no_production_baseline_no_deployment"
)

STAGE_ROOT = Path("stages") / STAGE59R_ID
...
SOURCE_STAGE59Q_ROOT = Path("stages") / SOURCE_STAGE59Q_ID
SOURCE_STAGE59Q_DECISION = SOURCE_STAGE59Q_ROOT / "03_reviews/stage59q_decision.md"
SOURCE_STAGE59Q_REPORT = SOURCE_STAGE59Q_ROOT / "03_reviews/bounded_followup_from_stage59p_report.md"
SOURCE_STAGE59Q_SUMMARY = SOURCE_STAGE59Q_ROOT / "03_reviews/bounded_followup_summary.csv"
SOURCE_STAGE59Q_JSON = SOURCE_STAGE59Q_ROOT / "03_reviews/bounded_followup_summary.json"
...
COMMON_ROOT = f"Project_Obsidian_Prime_v2/s59r/{RUN_NUMBER}"

REPORT_PATH = REVIEWS_ROOT / "bounded_followup_from_stage59q_report.md"
...
DECISION_PATH = REVIEWS_ROOT / "stage59r_decision.md"
AUDIT_CSV_PATH = REVIEWS_ROOT / "stage59r_trade_audit.csv"
...
STAGE59R_VARIANTS = (
    repair.RepairVariant(
        adapter_id="s59r_v61src_sl20_tp30_sd12_h5_rearm002",
        label="run50BQ_v61_transition_h2_source_sl20_tp30_sd12_h5_rearm002_risk3pct_atr",
        atr_enabled=True,
        ...
        max_hold_bars=5,
        notes="Stage59R bounded follow-up: keep Stage59Q h5/rearm002 adapter policy and swap to run50BQ v61 hold2 source anchor.",
    ),
    repair.RepairVariant(
        adapter_id="s59r_v62src_sl20_tp30_sd12_h5_rearm002",
        label="run50BQ_v62_transition_h4_source_sl20_tp30_sd12_h5_rearm002_risk3pct_atr",
        atr_enabled=True,
        model_risk_enabled=True,
        fixed_lot=0.25,
        atr_stop_multiplier=2.0,
        ...
        close_only_on_opposite_signal=True,
        max_hold_bars=5,
        notes="Stage59R bounded control: keep Stage59Q h5/rearm002 adapter policy on run50BQ v62 hold4 source anchor.",
    ),
    repair.RepairVariant(
        adapter_id="s59r_v63src_sl20_tp30_sd12_h5_rearm002",
        label="run50BQ_v63_transition_h6_source_sl20_tp30_sd12_h5_rearm002_risk3pct_atr",
        atr_enabled=True,
        model_risk_enabled=True,
        fixed_lot=0.25,
        atr_stop_multiplier=2.0,
        ...
        close_only_on_opposite_signal=True,
        max_hold_bars=5,
        notes="Stage59R bounded follow-up: keep Stage59Q h5/rearm002 adapter policy and swap to run50BQ v63 hold6 source anchor.",
    ),
)
...
def source_specs() -> dict[str, dict[str, Any]]:
    specs = {
        "s59r_v61src_sl20_tp30_sd12_h5_rearm002": {
        ...
        "s59r_v62src_sl20_tp30_sd12_h5_rearm002": {
        ...
        "s59r_v63src_sl20_tp30_sd12_h5_rearm002": {
    ...
    return {variant.adapter_id: specs[variant.adapter_id] for variant in STAGE59R_VARIANTS}

def configure_reused_engine() -> None:
    engine.STAGE59_ID = STAGE59R_ID
    ...
    engine.STAGE59_VARIANTS = STAGE59R_VARIANTS
    engine.SOURCE_SPECS = source_specs()
    engine.MODEL_RISK_MIN_PCT = {variant.adapter_id: 0.005 for variant in STAGE59R_VARIANTS}

    repair.STAGE_ID = STAGE59R_ID
    repair.RUN_NUMBER = RUN_NUMBER
    repair.RUN_ID = RUN_ID
    repair.RUN_ROOT = RUN_ROOT
    repair.REPAIR_VARIANTS = STAGE59R_VARIANTS
    s58.STAGE58_ID = STAGE59R_ID
    ...
    s58.STAGE58_VARIANTS = STAGE59R_VARIANTS
...
def build_attempts(inputs: Mapping[str, Any]) -> list[dict[str, Any]]:
    ...
    for variant_index, variant in enumerate(STAGE59R_VARIANTS, start=1):
            ...
            for role_index, (tier, attempt_role, prefix, attempt_token) in enumerate(
                ...
                attempts.append(
                    attempt_payload(
                        ...
                        run_id=RUN_ID,
                        stage_number=59,
                        exploration_label="stage59P_BaselineAdapter__MaxHoldPressureFromStage59Q",
...
def execute_prepared_run_checkpointed(prepared: Mapping[str, Any], args: argparse.Namespace) -> dict[str, Any]:
    ...
    return {
        **dict(prepared),
        ...
        "judgment": "inconclusive_stage59r_runtime_probe_completed" if completed and report_completed else "blocked_stage59r_runtime_probe",
    }
...
def next_stage_for_decision(decision: str) -> str:
    ...
    if decision == "demote_current_adapter_and_select_backup":
        return "59S_adapter_repair__backup_or_demote_from_stage59r"
    if decision == "open_bounded_followup":
        return "59S_adapter_repair__bounded_followup_from_stage59r"
...
def next_packet_for_decision(decision: str) -> tuple[str, str]:
    ...
    return "stage59s_bounded_followup_from_stage59r_v1", "run59N_stage59s_bounded_followup_from_stage59r_v1"
            ...
            rows.append(
                {
                    ...
                    "stage_id": STAGE59R_ID,
                    "run_id": RUN_ID,
                    "artifact_type": "stage59r_bounded_followup_evidence",
                    "path": rel(path),
                    "sha256": sha256_file_lf_normalized(path),
                    "created_at_utc": created,
                    "notes": "Stage59R bounded follow-up from Stage59Q artifact.",
                }
            )
            ...
            rows.append(
                {
                    ...
                    "created_at_utc": created,
                    "notes": "Actual Stage59R MT5 Strategy Tester HTML report.",
                }
            )
    return rows
...
def write_run_identity(result: Mapping[str, Any]) -> None:
    engine.write_json(
        RUN_ROOT / "run_manifest.json",
        {
            ...
            "bounded_question": "Can bounded run50BQ source-anchor switching on the Stage59Q h5/rearm002 adapter improve validation early and OOS mid segment weakness or OOS density without damaging PF, drawdown, cost stress, same-move concentration, ATR/risk telemetry, or starting ONNX?",
            "source_stage59q_decision": rel(SOURCE_STAGE59Q_DECISION),
            "source_stage59q_pushed_commit": SOURCE_STAGE59Q_PUSHED_COMMIT,
            "variants": [
                {
                    **variant.__dict__,
                ...
                for variant in STAGE59R_VARIANTS
            ],
...
def write_ledgers(
        ...
        [
            {
                "run_id": RUN_ID,
                "stage_id": STAGE59R_ID,
                "lane": "baseline_adapter_bounded_followup_from_stage59q",
                "status": status,
                "judgment": decision,
    ...
    ledger_rows.append(
        {
            "ledger_row_id": f"{RUN_ID}__aggregate_bounded_followup_from_stage59q",
            "stage_id": STAGE59R_ID,
            "run_id": RUN_ID,
            "subrun_id": "aggregate_bounded_followup_from_stage59q",
            "parent_run_id": PARENT_RUN_ID,
            "record_view": "bounded_followup_from_stage59q",
            "tier_scope": "Tier A+B",
            ...
            "external_verification_status": external,
            "notes": "Stage59R bounded source-anchor follow-up from Stage59Q evidence; not final package completion.",
        }
    )
...
def report_markdown(summary_rows: Sequence[Mapping[str, Any]], decision: str, reasons: Sequence[str], external: str) -> str:
    ...
    best = best_repaired_variant(summary_rows)
    return f"""# Stage59R Bounded Followup From Stage59Q Report(59R단계 59Q단계 기반 경계 후속 보고서)

- stage(단계): `{STAGE59R_ID}`
- run(실행): `{RUN_ID}`
...
def equity_audit_markdown(summary_rows: Sequence[Mapping[str, Any]], segment_rows: Sequence[Mapping[str, Any]]) -> str:
    ...
    return f"""# Stage59R Bounded Followup Equity Curve Audit(59R단계 경계 후속 자금 곡선 감사)
...
def decision_markdown(decision: str, reasons: Sequence[str], best: Mapping[str, Any], external: str) -> str:
    return f"""# Stage59R Decision(59R단계 판정)
    ...
    engine.write_json(
        SUMMARY_JSON_PATH,
        {
            ...
            "required_outputs": {
                ...
                "stage59r_decision": rel(DECISION_PATH),
            },
...
def write_packet_files(
    ...
    files = {
        ...
        "experiment_design_receipt.json": {
            "hypothesis": "A bounded source-anchor switch across run50BQ v61/v62/v63 on the Stage59Q h5/rearm002 adapter may improve validation early and OOS mid segment weakness or OOS density while preserving validation/OOS PF, cost stress, drawdown, same-move concentration, and ATR/risk telemetry.",
            ...
            "comparison_baseline": "Stage59Q best candidate s59q_v62_sl20_tp30_sd12_h5_rearm002.",
            ...
            "changed_variables": ["run50BQ_source_anchor"],
            ...
            "stop_conditions": "three bounded Stage59R source-anchor variants only",
        ...
        "artifact_lineage_audit.json": {
            "source_inputs": [rel(SOURCE_STAGE59Q_DECISION), rel(SOURCE_STAGE59Q_REPORT), rel(SOURCE_STAGE59Q_SUMMARY), rel(SOURCE_STAGE59Q_JSON)],
...
- stage_id(단계 ID): `{STAGE59R_ID}`
- source_stage(원천 단계): `{SOURCE_STAGE59Q_ID}`
- source_decision(원천 판정): `continue_repair_in_new_bounded_stage`
- bounded_question(경계 질문): `Can bounded run50BQ source-anchor switching on the Stage59Q h5/rearm002 adapter improve validation early and OOS mid segment weakness or OOS density without damaging PF, drawdown, cost stress, same-move concentration, ATR/risk telemetry, or starting ONNX?`
- boundary(경계): `{BOUNDARY}`

Stage59R(59R단계)는 Stage59Q(59Q단계) h5/rearm002 candidate(h5/rearm002 후보)의 adapter policy(어댑터 정책)를 유지하고 run50BQ source anchor(run50BQ 원천 기준점) 세 변형만 측정한다. Effect(효과): Stage60 ONNX(60단계 ONNX)나 deployment(배포)로 이어가지 않고 OOS 약점 수리 여부만 본다.
""",
    )
    engine.write_md(
...
- stage59q_decision(59Q단계 판정): `{rel(SOURCE_STAGE59Q_DECISION)}`
- stage59q_report(59Q단계 보고서): `{rel(SOURCE_STAGE59Q_REPORT)}`
- stage59q_summary(59Q단계 요약): `{rel(SOURCE_STAGE59Q_SUMMARY)}`
- stage59q_pushed_commit(59Q단계 푸시 커밋): `{SOURCE_STAGE59Q_PUSHED_COMMIT}`
...
- stage_status(단계 상태): `closed_bounded_followup_from_stage59q`
- source_stage(원천 단계): `{SOURCE_STAGE59Q_ID}`
- source_decision(원천 판정): `continue_repair_in_new_bounded_stage`
- stage59r_decision(59R단계 판정): `{decision}`
- next_stage_or_branch(다음 단계/분기): `{next_stage}`
- selected_research_baseline(선택 연구 기준선): `none`
- claim_boundary(주장 경계): `{BOUNDARY}`

Effect(효과): Stage59R(59R단계)는 측정 결과를 보존하지만 final package(최종 패키지)나 operating claim(운영 주장)을 만들지 않는다.
""",
    )
    engine.write_md(
...
- bounded_followup_risk_atr_telemetry(경계 후속 위험/ATR 텔레메트리): `{rel(RISK_ATR_TELEMETRY_PATH)}`
- stage59r_decision(59R단계 판정): `{rel(DECISION_PATH)}`
""",
    )
...
- source_stage(원천 단계): `{STAGE59R_ID}`
- source_decision(원천 판정): `{decision}`
- bounded_question(경계 질문): `What bounded follow-up should repair, demote, or branch from the Stage59R evidence without starting ONNX prematurely?`
- boundary(경계): `{BOUNDARY}`

Stage59S(59S단계)는 Stage59R(59R단계) 결과가 Stage60 ONNX(60단계 ONNX)에 충분하지 않을 때 이어지는 bounded follow-up(경계 후속)이다. Effect(효과): repair(수리), demotion(강등), branch(분기)를 다음 작은 질문으로 제한한다.
""",
        )
        engine.write_md(
...
- stage59r_decision(59R단계 판정): `{rel(DECISION_PATH)}`
- stage59r_report(59R단계 보고서): `{rel(REPORT_PATH)}`
- stage59r_summary(59R단계 요약): `{rel(SUMMARY_CSV_PATH)}`
- stage59r_segment_kpi(59R단계 구간 KPI): `{rel(SEGMENT_KPI_PATH)}`
- stage59r_risk_atr_telemetry(59R단계 위험/ATR 텔레메트리): `{rel(RISK_ATR_TELEMETRY_PATH)}`
""",
        )
        engine.write_md(
...
Stage59S(59S단계)는 planned(계획) 상태다. Effect(효과): Stage59R(59R단계) 약점을 다음 bounded repair(경계 수리) 근거로 넘긴다.
""",
        )
        engine.write_md(
...
- stage_status(단계 상태): `active_planned_from_stage59r`
- source_stage(원천 단계): `{STAGE59R_ID}`
- source_decision(원천 판정): `{decision}`
- selected_research_baseline(선택 연구 기준선): `none`
- claim_boundary(주장 경계): `{BOUNDARY}`

Effect(효과): Stage59S(59S단계)는 Stage59R(59R단계) 이후 필요한 다음 작은 질문만 다룬다.
""",
        )
...
- status(상태): `stage59r_closed_{decision}`
- claim_boundary(주장 경계): research/development only(연구/개발 전용)

Stage59R(59R단계) closed(종료) as bounded source-anchor follow-up from Stage59Q(59Q단계 기반 경계 원천 기준점 후속). Effect(효과): Stage59Q(59Q단계) segment/density weakness(구간/밀도 약점)는 보존하고, Stage60 ONNX(60단계 ONNX)는 품질 근거가 강할 때만 열린다.

## Latest Stage59R Evidence(최신 59R단계 근거)
...
""",
    ...
    focus = (
        "current_focus:\n"
        f"- >-\n"
        f"  Stage59R(59R단계) `{STAGE59R_ID}` closed(종료) as bounded source-anchor follow-up from Stage59Q(59Q단계 기반 경계 원천 기준점 후속); decision(판정)=`{decision}`. "
        ...
        f"- >-\n"
        f"  Next stage_or_branch(다음 단계/분기) `{next_stage}` is active/planned(활성/계획). Effect(효과): Stage59R(59R단계) 결과를 다음 bounded step(경계 다음 단계)으로 넘긴다.\n"
    )
    text = re.sub(
...
stage59r_bounded_followup_from_stage59q:
  packet_id: {PACKET_ID}
  stage_id: {STAGE59R_ID}
  status: closed_bounded_followup_from_stage59q
  ...
  boundary: {BOUNDARY}
"""
    if "stage59r_bounded_followup_from_stage59q:" in text:
        text = re.sub(r"\nstage59r_bounded_followup_from_stage59q:\n(?:  .*\n)*", block, text, count=1)
    else:
        text += block
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Stage59R bounded follow-up from Stage59Q.")
...
def load_existing_result() -> dict[str, Any]:
    ...
    if not path_exists(manifest) or not path_exists(kpi):
        raise FileNotFoundError("Stage59R existing run_manifest.json or kpi_record.json is missing")
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.finalize_existing:
        ...
        prepared = {
            ...
            "model_family": "baseline_adapter_stage59r_source_anchor_ebm_table",
            "feature_set_id": "stage59r_run50bq_source_anchor_discrete_signal",
