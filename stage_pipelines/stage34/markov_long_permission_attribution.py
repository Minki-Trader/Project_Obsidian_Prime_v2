...
from stage_pipelines.stage34 import attribution_read, common as stage34_common
...
utc_now = stage34_common.utc_now
read_json = stage34_common.read_json
write_json = stage34_common.write_json
write_md = stage34_common.write_md
write_csv = stage34_common.write_csv
safe_float = stage34_common.numeric


def active_branch() -> str:
    return stage34_common.active_branch(ROOT)
...
def build_read(tier_rows: Sequence[Mapping[str, Any]], segments: Sequence[Mapping[str, Any]], matched: pd.DataFrame) -> dict[str, Any]:
    return attribution_read.build_read(tier_rows, segments, matched)
