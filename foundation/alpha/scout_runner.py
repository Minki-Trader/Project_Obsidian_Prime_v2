...
def materialize_mt5_attempt_files(
    *,
    ...
    decision_mode: str = "threshold_margin",
    side_filter_enabled: bool = False,
    side_filter_feature_index: int = -1,
    fallback_side_filter_feature_index: int = -1,
    ...
    set_payload = materialize_tester_set_file(
        {
            ...
            "InpSideFilterEnabled": bool(side_filter_enabled),
            "InpSideFilterFeatureIndex": int(side_filter_feature_index),
            "InpFallbackSideFilterFeatureIndex": int(fallback_side_filter_feature_index),
            "InpBlockShortFeatureRange": bool(block_short_feature_range),
            "InpBlockShortFeatureMin": float(block_short_feature_min),
            "InpBlockShortFeatureMax": float(block_short_feature_max),
            "InpBlockLongFeatureRange": bool(block_long_feature_range),
            "InpBlockLongFeatureMin": float(block_long_feature_min),
            "InpBlockLongFeatureMax": float(block_long_feature_max),
            "InpAllowTrading": "true",
            "InpFixedLot": 0.1,
            "InpMaxHoldBars": int(max_hold_bars),
            "InpMaxConcurrentPositions": 1,
            "InpReentryCooldownBars": int(reentry_cooldown_bars),
            "InpSameDirectionReentryCooldownBars": int(same_direction_reentry_cooldown_bars),
            "InpEntryTransitionOnly": bool(entry_transition_only),
            "InpEntryTransitionRearmMinConfidenceDelta": float(entry_transition_rearm_min_confidence_delta),
    ...
    return {
        ...
        "side_filter": {
            ...
            "feature_index": int(side_filter_feature_index),
            "fallback_feature_index": int(fallback_side_filter_feature_index),
...
def materialize_mt5_routed_attempt_files(
    *,
    ...
    entry_transition_rearm_min_confidence_delta: float = 0.0,
    decision_mode: str = "threshold_margin",
    fallback_decision_mode: str = "threshold_margin",
    ...
    set_payload = materialize_tester_set_file(
        {
            ...
            "InpFallbackDecisionMode": fallback_decision_mode,
    ...
    *,
    ...
    for split_label, (source_split, from_date, to_date) in split_specs.items():
        ...
        tier_a_attempt = materialize_mt5_attempt_files(
            ...
            side_filter_feature_index=tier_a_side_filter_feature_index,
            fallback_side_filter_feature_index=-1,
        ...
        tier_b_attempt = materialize_mt5_attempt_files(
            ...
            entry_transition_rearm_min_confidence_delta=entry_transition_rearm_min_confidence_delta,
            side_filter_enabled=side_filter_enabled,
            side_filter_feature_index=tier_b_side_filter_feature_index,
            fallback_side_filter_feature_index=tier_b_side_filter_feature_index,
            block_short_feature_range=block_short_feature_range,
            block_short_feature_min=block_short_feature_min,
            block_short_feature_max=block_short_feature_max,
            block_long_feature_range=block_long_feature_range,
